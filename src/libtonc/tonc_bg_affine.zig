...
pub export fn bg_aff_rotate(arg_bgaff: [*c]BG_AFFINE, arg_alpha: @"u16") void {
    var bgaff = arg_bgaff;
    _ = &bgaff;
    var alpha = arg_alpha;
    _ = &alpha;
    ...
    _ = &cc;
    bgaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(cc))));
    bgaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(-ss))));
    bgaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(ss))));
    bgaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(cc))));
}
pub export fn bg_aff_rotscale(arg_bgaff: [*c]BG_AFFINE, arg_sx: c_int, arg_sy: c_int, arg_alpha: @"u16") void {
    var bgaff = arg_bgaff;
    _ = &bgaff;
    var sx = arg_sx;
    _ = &sx;
    ...
    _ = &cc;
    bgaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate((cc * sx) >> @intCast(12)))));
    bgaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate((-ss * sx) >> @intCast(12)))));
    bgaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate((ss * sy) >> @intCast(12)))));
    bgaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate((cc * sy) >> @intCast(12)))));
}
pub export fn bg_aff_premul(arg_dst: [*c]BG_AFFINE, arg_src: [*c]const BG_AFFINE) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
...
pub export fn bg_aff_postmul(arg_dst: [*c]BG_AFFINE, arg_src: [*c]const BG_AFFINE) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
...
pub export fn bg_aff_rotscale2(arg_bgaff: [*c]BG_AFFINE, arg_as: [*c]const AFF_SRC) void {
    var bgaff = arg_bgaff;
    _ = &bgaff;
    var as = arg_as;
    _ = &as;
    ...
    _ = &cc;
    bgaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate((cc * @as(c_int, @bitCast(@as(c_int, as.*.sx)))) >> @intCast(12)))));
    bgaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate((-ss * @as(c_int, @bitCast(@as(c_int, as.*.sx)))) >> @intCast(12)))));
    bgaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate((ss * @as(c_int, @bitCast(@as(c_int, as.*.sy)))) >> @intCast(12)))));
    bgaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate((cc * @as(c_int, @bitCast(@as(c_int, as.*.sy)))) >> @intCast(12)))));
}
pub export fn bg_rotscale_ex(arg_bgaff: [*c]BG_AFFINE, arg_asx: [*c]const AFF_SRC_EX) void {
    var bgaff = arg_bgaff;
    _ = &bgaff;
    var asx = arg_asx;
    _ = &asx;
    ...
    _ = &sy;
    var sina: c_int = lu_sin(@as(uint, @bitCast(@as(c_uint, asx.*.alpha))));
    _ = &sina;
    var cosa: c_int = lu_cos(@as(uint, @bitCast(@as(c_uint, asx.*.alpha))));
    _ = &cosa;
    var pa: FIXED = undefined;
    _ = &pa;
    var pb: FIXED = undefined;
    _ = &pb;
    var pc: FIXED = undefined;
    _ = &pc;
    var pd: FIXED = undefined;
    _ = &pd;
    pa = (sx * cosa) >> @intCast(12);
    pb = (-sx * sina) >> @intCast(12);
    pc = (sy * sina) >> @intCast(12);
    pd = (sy * cosa) >> @intCast(12);
    bgaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(pa))));
    bgaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(pb))));
    bgaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(pc))));
    bgaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(pd))));
    bgaff.*.dx = asx.*.tex_x - ((pa * @as(c_int, @bitCast(@as(c_int, asx.*.scr_x)))) + (pb * @as(c_int, @bitCast(@as(c_int, asx.*.scr_y)))));
    bgaff.*.dy = asx.*.tex_y - ((pc * @as(c_int, @bitCast(@as(c_int, asx.*.scr_x)))) + (pd * @as(c_int, @bitCast(@as(c_int, asx.*.scr_y)))));
}

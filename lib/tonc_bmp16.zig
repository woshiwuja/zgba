...
pub export fn bmp16_plot(arg_x: c_int, arg_y: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    var dstP = arg_dstP;
    _ = &dstP;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x * @as(c_int, 2))))))));
    _ = &dstL;
    dstL[@as(c_uint, @intCast(@as(c_int, 0)))] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
}
pub export fn bmp16_hline(arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x1 = arg_x1;
    _ = &x1;
    var y = arg_y;
    _ = &y;
    ...
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x1 * @as(c_int, 2))))))));
    _ = &dstL;
    memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), @as(uint, @bitCast((x2 - x1) + @as(c_int, 1))));
}
pub export fn bmp16_vline(arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x = arg_x;
    _ = &x;
    var y1 = arg_y1;
    _ = &y1;
    ...
    _ = &height;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(dstBase + (@as(uint, @bitCast(y1)) *% dstP))));
    _ = &dstL;
...
pub export fn bmp16_line(arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x1 = arg_x1;
    _ = &x1;
    var y1 = arg_y1;
    _ = &y1;
    ...
    _ = &dd;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y1)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x1 * @as(c_int, 2))))))));
    _ = &dstL;
    dstP /= @as(uint, @bitCast(@as(c_int, 2)));
    if (x1 > x2) {
        xstep = -@as(c_int, 1);
    ...
    if (dy == @as(c_int, 0)) {
        ...
        dd = (@as(c_int, 2) * dy) - dx;
        {
            ii = 0;
            while (ii <= dx) : (ii += 1) {
                dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
                if (dd >= @as(c_int, 0)) {
                    dd -= @as(c_int, 2) * dx;
...
pub export fn bmp16_rect(arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var left = arg_left;
    _ = &left;
    var top = arg_top;
    _ = &top;
    ...
    _ = &height;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(top)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(left * @as(c_int, 2))))))));
    _ = &dstL;
    dstP /= @as(uint, @bitCast(@as(c_int, 2)));
    while ((blk: {
        const ref = &height;
...
pub export fn bmp16_frame(arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var left = arg_left;
    _ = &left;
    var top = arg_top;
    _ = &top;
    ...
    dstP /= @as(uint, @bitCast(@as(c_int, 2)));
    memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width);
    if (height < @as(uint, @bitCast(@as(c_int, 2)))) return;
    dstL += dstP;
    height -%= @as(uint, @bitCast(@as(c_int, 2)));
    while ((blk: {
        const ref = &height;
        const tmp_1 = ref.*;
        ref.* -%= 1;
        ...
        dstL[@as(c_uint, @intCast(@as(c_int, 0)))] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
        dstL[width -% @as(uint, @bitCast(@as(c_int, 1)))] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
        dstL += dstP;
    }
    memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width);
}

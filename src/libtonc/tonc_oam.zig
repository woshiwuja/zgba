...
pub export fn oam_init(arg_obj: [*c]OBJ_ATTR, arg_count: uint) void {
    var obj = arg_obj;
    _ = &obj;
    var count = arg_count;
    _ = &count;
    var nn: @"u32" = (count +% @as(uint, @bitCast(@as(c_int, 3)))) >> @intCast(2);
    _ = &nn;
    var dst: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(obj)));
    _ = &dst;
    while ((blk: {
        const ref = &nn;
        const tmp = ref.*;
        ...
        (blk: {
            ...
            ref.* += 1;
            break :blk tmp;
        }).* = @as(@"u32", @bitCast(@as(c_int, 512)));
        (blk: {
            const ref = &dst;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).* = @as(@"u32", @bitCast(@as(c_int, 256) << @intCast(16)));
        (blk: {
            const ref = &dst;
            const tmp = ref.*;
            ref.* += 1;
    ...
    oam_copy(@as([*c]OBJ_ATTR, @ptrFromInt(@as(c_int, 117440512))), obj, count);
}
...
pub export fn obj_copy(arg_dst: [*c]OBJ_ATTR, arg_src: [*c]const OBJ_ATTR, arg_count: uint) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
...
pub export fn obj_hide_multi(arg_obj: [*c]OBJ_ATTR, arg_count: uint) void {
    var obj = arg_obj;
    _ = &obj;
    var count = arg_count;
    _ = &count;
...
pub export fn obj_unhide_multi(arg_obj: [*c]OBJ_ATTR, arg_mode: @"u16", arg_count: uint) void {
    var obj = arg_obj;
    _ = &obj;
    var mode = arg_mode;
    _ = &mode;
...
pub extern fn obj_aff_copy(dst: [*c]OBJ_AFFINE, src: [*c]const OBJ_AFFINE, count: uint) void;
...
pub extern fn obj_aff_rotate(oaff: [*c]OBJ_AFFINE, alpha: @"u16") void;
pub extern fn obj_aff_rotscale(oaff: [*c]OBJ_AFFINE, sx: FIXED, sy: FIXED, alpha: @"u16") void;
pub extern fn obj_aff_premul(dst: [*c]OBJ_AFFINE, src: [*c]const OBJ_AFFINE) void;
pub extern fn obj_aff_postmul(dst: [*c]OBJ_AFFINE, src: [*c]const OBJ_AFFINE) void;
pub extern fn obj_aff_rotscale2(oaff: [*c]OBJ_AFFINE, as: [*c]const AFF_SRC) void;
pub extern fn obj_rotscale_ex(obj: [*c]OBJ_ATTR, oaff: [*c]OBJ_AFFINE, asx: [*c]const AFF_SRC_EX) void;

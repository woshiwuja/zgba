...
pub export fn schr4r_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
...
pub export fn schr4r_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
...
pub export fn schr4r_hline(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(((dst.*.data + (@as(@"u32", @bitCast(y >> @intCast(3))) *% dst.*.pitch)) + @as(usize, @bitCast(@as(isize, @intCast((y & @as(c_int, 7)) * @as(c_int, 4)))))) + @as(usize, @bitCast(@as(isize, @intCast((x1 >> @intCast(3)) * @as(c_int, 32))))))));
    _ = &dstD;
    ...
    if (left != @as(uint, @bitCast(@as(c_int, 0)))) {
        ...
        dstD += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8)))));
    }
...
pub export fn schr4r_vline(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var dstL: [*c]@"u32" = schr4r_get_ptr(dst, x, y1);
    _ = &dstL;
    ...
    while ((blk: {
        ...
        dstL.* = (dstL.* & ~mask) | clr;
        dstL += 1;
        if ((@as(@"u32", @intCast(@intFromPtr(dstL))) % @as(@"u32", @bitCast(@as(c_int, 32)))) == @as(@"u32", @bitCast(@as(c_int, 0)))) {
            dstL += dstP -% @as(uint, @bitCast(@as(c_int, 8)));
        }
    }
}
pub export fn schr4r_line(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    if (dx >= dy) {
        dd = (@as(c_int, 2) * dy) - dx;
        {
            ii = 0;
            while (ii <= dx) : (ii += 1) {
                chr4r_plot(x1, y1, clr, @as(?*anyopaque, @ptrCast(dst.*.data)), dst.*.pitch);
                if (dd >= @as(c_int, 0)) {
                    dd -= @as(c_int, 2) * dx;
                    y1 += ystep;
                }
...
pub export fn schr4r_rect(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    _ = &dstP;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(((dst.*.data + (@as(uint, @bitCast(top >> @intCast(3))) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast((top & @as(c_int, 7)) * @as(c_int, 4)))))) + @as(usize, @bitCast(@as(isize, @intCast((left >> @intCast(3)) * @as(c_int, 32))))))));
    _ = &dstD;
    if ((((left | right) & @as(c_int, 7)) == @as(c_int, 0)) and (((top | bottom) & @as(c_int, 7)) == @as(c_int, 0))) {
        height /= @as(uint, @bitCast(@as(c_int, 8)));
        while ((blk: {
            const ref = &height;
            const tmp = ref.*;
            ref.* -%= 1;
            ...
            memset32(@as(?*anyopaque, @ptrCast(dstD)), clr, width);
            dstD += dstP / @as(uint, @bitCast(@as(c_int, 4)));
        }
        return;
    }
    var x0: uint = @as(uint, @bitCast(left & @as(c_int, 7)));
    _ = &x0;
    if ((x0 +% width) <= @as(uint, @bitCast(@as(c_int, 8)))) {
        chr4r_colset(dstD, dstP / @as(uint, @bitCast(@as(c_int, 4))), x0, x0 +% width, height, clr);
        return;
    }
    if (x0 != @as(uint, @bitCast(@as(c_int, 0)))) {
        chr4r_colset(dstD, dstP / @as(uint, @bitCast(@as(c_int, 4))), x0, @as(uint, @bitCast(@as(c_int, 8))), height, clr);
        width -%= @as(uint, @bitCast(@as(c_int, 8))) -% x0;
        dstD += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8)))));
    }
    if ((width & @as(uint, @bitCast(@as(c_int, 7)))) != 0) {
        chr4r_colset(&dstD[width & @as(uint, @bitCast(~@as(c_int, 7)))], dstP / @as(uint, @bitCast(@as(c_int, 4))), @as(uint, @bitCast(@as(c_int, 0))), width & @as(uint, @bitCast(@as(c_int, 7))), height, clr);
        width &= @as(uint, @bitCast(~@as(c_int, 7)));
    }
    if (width == @as(uint, @bitCast(@as(c_int, 0)))) return;
    var ix: uint = undefined;
    _ = &ix;
    var iy: uint = undefined;
    _ = &iy;
    var y0: uint = @as(uint, @bitCast(top & @as(c_int, 7)));
    _ = &y0;
    if (y0 != @as(uint, @bitCast(@as(c_int, 0)))) {
        var h2: uint = if ((y0 +% height) <= @as(uint, @bitCast(@as(c_int, 8)))) height else @as(uint, @bitCast(@as(c_int, 8))) -% y0;
        _ = &h2;
        {
            iy = 0;
            while (iy < h2) : (iy +%= 1) {
                {
                    ix = 0;
                    while (ix < width) : (ix +%= @as(uint, @bitCast(@as(c_int, 8)))) {
                        dstD[ix] = clr;
                    }
                }
                dstD += 1;
        ...
        height -%= h2;
        dstD += (dstP / @as(uint, @bitCast(@as(c_int, 4)))) -% @as(uint, @bitCast(@as(c_int, 8)));
    }
    {
        iy = 0;
        while (iy < (height / @as(uint, @bitCast(@as(c_int, 8))))) : (iy +%= 1) {
            memset32(@as(?*anyopaque, @ptrCast(dstD)), clr, width);
            dstD += dstP / @as(uint, @bitCast(@as(c_int, 4)));
        }
    }
    height &= @as(uint, @bitCast(@as(c_int, 7)));
    {
        iy = 0;
...
pub export fn schr4r_frame(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    var height: uint = @as(uint, @bitCast(bottom - top));
    _ = &height;
    schr4r_hline(dst, left, top, right - @as(c_int, 1), clr);
    if (height == @as(uint, @bitCast(@as(c_int, 1)))) return;
    schr4r_hline(dst, left, bottom - @as(c_int, 1), right - @as(c_int, 1), clr);
    if (height > @as(uint, @bitCast(@as(c_int, 2)))) {
        schr4r_vline(dst, left, top, bottom - @as(c_int, 1), clr);
        schr4r_vline(dst, right - @as(c_int, 1), top, bottom - @as(c_int, 1), clr);
    }
}
pub export fn schr4r_prep_map(arg_srf: [*c]const TSurface, arg_map: [*c]@"u16", arg_se0: @"u16") void {
    var srf = arg_srf;
    _ = &srf;
    var map = arg_map;
    _ = &map;
    ...
    _ = &pitch;
    {
        ...
        while (iy < height) : (iy +%= 1) {
            ix = 0;
            while (ix < width) : (ix +%= 1) {
                map[(iy *% @as(uint, @bitCast(@as(c_int, 32)))) +% ix] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(((iy *% pitch) +% ix) +% @as(uint, @bitCast(@as(c_uint, se0)))))));
            }
        }
    }
}
pub export fn schr4r_get_ptr(arg_srf: [*c]const TSurface, arg_x: c_int, arg_y: c_int) [*c]@"u32" {
    var srf = arg_srf;
    _ = &srf;
    var x = arg_x;
    _ = &x;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    return @as([*c]@"u32", @ptrCast(@alignCast(((srf.*.data + ((yy / @as(uint, @bitCast(@as(c_int, 8)))) *% srf.*.pitch)) + ((yy % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 32)))))));
}
...
pub fn chr4r_plot(arg_x: c_int, arg_y: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: @"u32") callconv(.c) void {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(((dstBase + ((yy / @as(uint, @bitCast(@as(c_int, 8)))) *% dstP)) + ((yy % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 32)))))));
    _ = &dstD;
    var shift: @"u32" = @as(@"u32", @bitCast((x & @as(c_int, 7)) * @as(c_int, 4)));
    _ = &shift;
    dstD.* = (dstD.* & @as(@"u32", @bitCast(~(@as(c_int, 15) << @intCast(shift))))) | ((clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift));
}
pub fn chr4r_colset(arg_dstD: [*c]@"u32", arg_dstP4: uint, arg_left: uint, arg_right: uint, arg_height: uint, arg_clr: @"u32") callconv(.c) void {
    var dstD = arg_dstD;
    _ = &dstD;
    var dstP4 = arg_dstP4;
    _ = &dstP4;
    ...
    while ((blk: {
        ...
        dstD.* = (dstD.* & ~mask) | clr;
        dstD += 1;
        if ((@as(@"u32", @intCast(@intFromPtr(dstD))) % @as(@"u32", @bitCast(@as(c_int, 32)))) == @as(@"u32", @bitCast(@as(c_int, 0)))) {
            dstD += dstP4 -% @as(uint, @bitCast(@as(c_int, 8)));
        }
    }
}

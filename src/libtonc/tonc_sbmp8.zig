...
pub fn qran_range(arg_min: c_int, arg_max: c_int) callconv(.c) c_int {
    var min = arg_min;
    _ = &min;
    var max = arg_max;
    _ = &max;
    return ((qran() * (max - min)) >> @intCast(15)) + min;
}
...
pub export fn sbmp8_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
...
pub const pixel_t = @"u8";
pub export fn sbmp8_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var dstD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(@as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x & ~@as(c_int, 1)))) *% @sizeOf(pixel_t))))))));
    _ = &dstD;
    if ((x & @as(c_int, 1)) != 0) {
...
pub export fn sbmp8_hline(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    _ = toncset(@as(?*anyopaque, @ptrCast(@as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x1))) *% @sizeOf(pixel_t))))))), @as(@"u8", @bitCast(@as(u8, @truncate(clr)))), @as(uint, @bitCast((x2 - x1) + @as(c_int, 1))));
}
pub export fn sbmp8_vline(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(@as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y1)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x & ~@as(c_int, 1)))) *% @sizeOf(pixel_t))))))));
    _ = &dstL;
    var dstP: uint = dst.*.pitch / @as(@"u32", @bitCast(@as(c_int, 2)));
    _ = &dstP;
    var height: uint = @as(uint, @bitCast((y2 - y1) + @as(c_int, 1)));
    _ = &height;
    if ((x & @as(c_int, 1)) != 0) {
        clr <<= @intCast(@as(c_int, 8));
        while ((blk: {
            const ref = &height;
            const tmp = ref.*;
            ref.* -%= 1;
            ...
            dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstL.*))) & @as(c_int, 255))) +% clr))));
            dstL += dstP;
        }
    } else {
        clr &= @as(@"u32", @bitCast(@as(c_int, 255)));
        while ((blk: {
            const ref = &height;
            const tmp = ref.*;
            ref.* -%= 1;
...
pub export fn sbmp8_line(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    _ = &dd;
    var dstP: uint = dst.*.pitch;
    _ = &dstP;
    var addr: @"u32" = @as(@"u32", @intCast(@intFromPtr((dst.*.data + (@as(uint, @bitCast(y1)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x1)))))));
    _ = &addr;
    var mask: @"u32" = 255;
    _ = &mask;
    var dstL: [*c]@"u16" = undefined;
    _ = &dstL;
    clr &= mask;
    clr |= clr << @intCast(8);
    if ((x1 & @as(c_int, 1)) != 0) {
    ...
    if (dx >= dy) {
        ...
        {
            ii = dx;
            while (ii >= @as(c_int, 0)) : (ii -= 1) {
                dstL = @as([*c]@"u16", @ptrFromInt(addr -% (mask >> @intCast(31))));
                dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate((@as(@"u32", @bitCast(@as(c_uint, dstL.*))) & ~mask) | (clr & mask)))));
                if (dd >= @as(c_int, 0)) {
                    dd -= @as(c_int, 2) * dx;
                    addr +%= @as(@"u32", @bitCast(ystep));
                }
                dd += @as(c_int, 2) * dy;
                addr +%= @as(@"u32", @bitCast(xstep));
                mask = ~mask;
            }
        }
    } else {
...
pub export fn sbmp8_rect(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(top)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, left))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var dstP: uint = @as(uint, @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstP;
    ...
    while ((blk: {
        ...
        _ = toncset(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u8", @bitCast(@as(u8, @truncate(clr)))), width);
        dstL += dstP;
    }
}
pub export fn sbmp8_frame(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    _ = toncset(@as(?*anyopaque, @ptrCast(dstL + ((height -% @as(uint, @bitCast(@as(c_int, 1)))) *% dstP))), @as(@"u8", @bitCast(@as(u8, @truncate(clr)))), width);
    if (height > @as(uint, @bitCast(@as(c_int, 2)))) {
        sbmp8_vline(dst, left, top, bottom - @as(c_int, 1), clr);
        sbmp8_vline(dst, right - @as(c_int, 1), top, bottom - @as(c_int, 1), clr);
    }
}
pub export fn sbmp8_blit(arg_dst: [*c]const TSurface, arg_dstX: c_int, arg_dstY: c_int, arg_width: uint, arg_height: uint, arg_src: [*c]const TSurface, arg_srcX: c_int, arg_srcY: c_int) void {
    var dst = arg_dst;
    _ = &dst;
    var dstX = arg_dstX;
    _ = &dstX;
    ...
    var srcL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((src.*.data + (@as(@"u32", @bitCast(srcY)) *% src.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, srcX))) *% @sizeOf(pixel_t)))));
    _ = &srcL;
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(dstY)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, dstX))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var srcP: uint = @as(uint, @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, src.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &srcP;
    var dstP: uint = @as(uint, @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstP;
    while ((blk: {
        ...
        _ = tonccpy(@as(?*anyopaque, @ptrCast(dstL)), @as(?*const anyopaque, @ptrCast(srcL)), @as(uint, @bitCast(w)));
        srcL += srcP;
        dstL += dstP;
    }
}
pub export fn sbmp8_floodfill(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var clrOld: pixel_t = dstL[@as(c_uint, @intCast(@as(c_int, 0)))];
    _ = &clrOld;
    if (clr == @as(@"u32", @bitCast(@as(c_uint, clrOld)))) return;
    sbmp8_floodfill_internal(dst, x, y, @as(@"u8", @bitCast(@as(u8, @truncate(clr)))), clrOld);
}
...
pub extern fn schr4c_get_pixel(src: [*c]const TSurface, x: c_int, y: c_int) @"u32";
pub extern fn schr4c_plot(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub extern fn schr4c_hline(dst: [*c]const TSurface, x1: c_int, y: c_int, x2: c_int, clr: @"u32") void;
pub extern fn schr4c_vline(dst: [*c]const TSurface, x: c_int, y1: c_int, y2: c_int, clr: @"u32") void;
pub extern fn schr4c_line(dst: [*c]const TSurface, x1: c_int, y1: c_int, x2: c_int, y2: c_int, clr: @"u32") void;
pub extern fn schr4c_rect(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn schr4c_frame(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn schr4c_blit(dst: [*c]const TSurface, dstX: c_int, dstY: c_int, width: uint, height: uint, src: [*c]const TSurface, srcX: c_int, srcY: c_int) void;
pub extern fn schr4c_floodfill(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub extern fn schr4c_prep_map(srf: [*c]const TSurface, map: [*c]@"u16", se0: @"u16") void;
pub extern fn schr4c_get_ptr(srf: [*c]const TSurface, x: c_int, y: c_int) [*c]@"u32";
...
pub export fn sbmp8_floodfill_internal(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clrNew: @"u8", arg_clrOld: @"u8") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    _ = &clrOld;
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 0)))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var dstPitch: uint = @as(uint, @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstPitch;
    ...
    while ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = left - @as(c_int, 1);
        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (left > @as(c_int, 0))) {
        left -= 1;
    }
    while ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = right + @as(c_int, 1);
        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (right < (@as(c_int, @bitCast(@as(c_uint, dst.*.width))) - @as(c_int, 1)))) {
        right += 1;
    }
    _ = toncset(@as(?*anyopaque, @ptrCast(&(blk: {
        const tmp = left;
        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)), clrNew, @as(uint, @bitCast((right + @as(c_int, 1)) - left)));
    {
        ii = left;
        while (ii <= right) : (ii += 1) {
            if ((@as(c_int, @bitCast(@as(c_uint, dstL[@as(uint, @bitCast(ii)) -% dstPitch]))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (y > @as(c_int, 0))) {
                sbmp8_floodfill_internal(dst, ii, y - @as(c_int, 1), clrNew, clrOld);
            }
            if ((@as(c_int, @bitCast(@as(c_uint, dstL[@as(uint, @bitCast(ii)) +% dstPitch]))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (@as(uint, @bitCast(y + @as(c_int, 1))) < dstH)) {
                sbmp8_floodfill_internal(dst, ii, y + @as(c_int, 1), clrNew, clrOld);
            }
        }
    }
...
pub inline fn BG_BUILD(cbb: anytype, sbb: anytype, size: anytype, bpp: anytype, prio: anytype, mos: anytype, wrap: anytype) @TypeOf(((((((size << @as(c_int, 14)) | ((wrap & @as(c_int, 1)) << @as(c_int, 13))) | ((sbb & @as(c_int, 31)) << @as(c_int, 8))) | ((bpp & @as(c_int, 8)) << @as(c_int, 4))) | ((mos & @as(c_int, 1)) << @as(c_int, 6))) | ((cbb & @as(c_int, 3)) << @as(c_int, 2))) | (prio & @as(c_int, 3))) {
    _ = &cbb;
    _ = &sbb;
    _ = &size;
    _ = &bpp;
    ...
    _ = &mos;
    _ = &wrap;
    return ((((((size << @as(c_int, 14)) | ((wrap & @as(c_int, 1)) << @as(c_int, 13))) | ((sbb & @as(c_int, 31)) << @as(c_int, 8))) | ((bpp & @as(c_int, 8)) << @as(c_int, 4))) | ((mos & @as(c_int, 1)) << @as(c_int, 6))) | ((cbb & @as(c_int, 3)) << @as(c_int, 2))) | (prio & @as(c_int, 3));
}
...
pub const PXSIZE = @import("std").zig.c_translation.sizeof(pixel_t);
pub inline fn PXPTR(psrf: anytype, x: anytype, y: anytype) [*c]pixel_t {
    _ = &psrf;
    _ = &x;
    _ = &y;
    return @import("std").zig.c_translation.cast([*c]pixel_t, (psrf.*.data + (y * psrf.*.pitch)) + (x * @import("std").zig.c_translation.sizeof(pixel_t)));
}
pub const BLIT_CLIP = @compileError("unable to translate C expr: unexpected token 'do'");
// ./src/tonc_sbmp8.c:325:9

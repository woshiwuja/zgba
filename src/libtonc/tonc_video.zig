...
pub export fn vid_flip() [*c]@"u16" {
    vid_page = @as([*c]COLOR, @ptrFromInt(@as(@"u32", @intCast(@intFromPtr(vid_page))) ^ @as(@"u32", @bitCast(@as(c_int, 40960)))));
    @as([*c]volatile vu32, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 0))).* ^= @as(vu32, @bitCast(@as(@"u32", @bitCast(@as(c_int, 16)))));
    return vid_page;
}

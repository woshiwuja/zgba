...
pub export fn bmp8_plot(arg_x: c_int, arg_y: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    var dstP = arg_dstP;
    _ = &dstP;
    var dstD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x & ~@as(c_int, 1))))))));
    _ = &dstD;
    if ((x & @as(c_int, 1)) != 0) {
...
pub export fn bmp8_hline(arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x1 = arg_x1;
    _ = &x1;
    var y = arg_y;
    _ = &y;
    ...
    _ = &width;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x1 & ~@as(c_int, 1))))))));
    _ = &dstL;
    if ((x1 & @as(c_int, 1)) != 0) {
        dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstL.*))) & @as(c_int, 255))) +% (clr << @intCast(8))))));
        width -%= 1;
        dstL += 1;
    }
    if ((width & @as(uint, @bitCast(@as(c_int, 1)))) != 0) {
        dstL[width / @as(uint, @bitCast(@as(c_int, 2)))] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstL[width / @as(uint, @bitCast(@as(c_int, 2)))]))) & ~@as(c_int, 255))) +% clr))));
    }
    width /= @as(uint, @bitCast(@as(c_int, 2)));
    if (width != 0) {
        memset16(@as(?*anyopaque, @ptrCast(dstL)), dup8(@as(@"u8", @bitCast(@as(u8, @truncate(clr))))), width);
    }
}
pub export fn bmp8_vline(arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x = arg_x;
    _ = &x;
    var y1 = arg_y1;
    _ = &y1;
    ...
    _ = &height;
    var dstL: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(y1)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x & ~@as(c_int, 1))))))));
    _ = &dstL;
    dstP /= @as(uint, @bitCast(@as(c_int, 2)));
    if ((x & @as(c_int, 1)) != 0) {
...
pub export fn bmp8_line(arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var x1 = arg_x1;
    _ = &x1;
    var y1 = arg_y1;
    _ = &y1;
    ...
    if (y1 == y2) {
        if (x2 == x1) {
            bmp8_plot(x1, y1, clr, dstBase, dstP);
            return;
        }
    ...
    _ = &dd;
    var addr: @"u32" = @as(@"u32", @intCast(@intFromPtr((dstBase + (@as(uint, @bitCast(y1)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(x1)))))));
    _ = &addr;
    var mask: @"u32" = 255;
    _ = &mask;
...
pub export fn bmp8_rect(arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var left = arg_left;
    _ = &left;
    var top = arg_top;
    _ = &top;
    ...
    _ = &height;
    var dstD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dstBase + (@as(uint, @bitCast(top)) *% dstP)) + @as(usize, @bitCast(@as(isize, @intCast(left & ~@as(c_int, 1))))))));
    _ = &dstD;
    var dstL: [*c]@"u16" = undefined;
    _ = &dstL;
    dstP /= @as(uint, @bitCast(@as(c_int, 2)));
    if ((left & @as(c_int, 1)) != 0) {
        dstL = dstD;
        {
            iy = 0;
            while (@as(uint, @bitCast(iy)) < height) : (iy += 1) {
                dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstL.*))) & @as(c_int, 255))) | (clr << @intCast(8))))));
                dstL += dstP;
            }
        }
        width -%= @as(uint, @bitCast(@as(c_int, 1)));
        dstD += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    }
    if ((width & @as(uint, @bitCast(@as(c_int, 1)))) != 0) {
        dstL = dstD + (width / @as(uint, @bitCast(@as(c_int, 2))));
        {
            iy = 0;
            while (@as(uint, @bitCast(iy)) < height) : (iy += 1) {
                dstL.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstL.*))) & ~@as(c_int, 255))) | clr))));
    ...
    dstL = dstD;
    {
        iy = 0;
        while (@as(uint, @bitCast(iy)) < height) : (iy += 1) {
            memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width / @as(uint, @bitCast(@as(c_int, 2))));
            dstL += dstP;
        }
    }
}
pub export fn bmp8_frame(arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: uint) void {
    var left = arg_left;
    _ = &left;
    var top = arg_top;
    _ = &top;

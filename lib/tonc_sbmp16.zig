...
pub const pixel_t = @"u16";
pub export fn sbmp16_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    return @as(@"u32", @bitCast(@as(c_uint, @as([*c]@"u16", @ptrCast(@alignCast(@as([*c]pixel_t, @ptrCast(@alignCast((src.*.data + (@as(@"u32", @bitCast(y)) *% src.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x))) *% @sizeOf(pixel_t)))))))).*)));
}
pub export fn sbmp16_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    @as([*c]@"u16", @ptrCast(@alignCast(@as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x))) *% @sizeOf(pixel_t)))))))).* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
}
pub export fn sbmp16_hline(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    memset16(@as(?*anyopaque, @ptrCast(@as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x1))) *% @sizeOf(pixel_t))))))), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), @as(uint, @bitCast((x2 - x1) + @as(c_int, 1))));
}
pub export fn sbmp16_vline(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var height: @"u32" = @as(@"u32", @bitCast((y2 - y1) + @as(c_int, 1)));
    _ = &height;
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y1)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var dstP: @"u32" = @as(@"u32", @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstP;
    while ((blk: {
        const ref = &height;
        const tmp = ref.*;
        ...
        dstL.* = @as(pixel_t, @bitCast(@as(c_ushort, @truncate(clr))));
        dstL += dstP;
    }
}
pub export fn sbmp16_line(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    _ = &dd;
    var dstL: [*c]pixel_t = @as([*c]pixel_t, @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y1)) *% dst.*.pitch)) + (@as(c_ulonglong, @bitCast(@as(c_longlong, x1))) *% @sizeOf(pixel_t)))));
    _ = &dstL;
    var dstP: @"u32" = @as(@"u32", @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstP;
    if (x1 > x2) {
    ...
    if (dy == @as(c_int, 0)) {
        {
            ...
            while (ii <= dx) : (ii += 1) {
                ...
                }).* = @as(pixel_t, @bitCast(@as(c_ushort, @truncate(clr))));
            }
        }
    } else if (dx == @as(c_int, 0)) {
        {
            ii = 0;
            while (ii <= dy) : (ii += 1) {
                (blk: {
        ...
        dd = (@as(c_int, 2) * dy) - dx;
        {
            ...
            while (ii <= dx) : (ii += 1) {
                ...
                if (dd >= @as(c_int, 0)) {
                    dd -= @as(c_int, 2) * dx;
                    dstL += @as(usize, @bitCast(@as(isize, @intCast(ystep))));
                }
                dd += @as(c_int, 2) * dy;
                dstL += @as(usize, @bitCast(@as(isize, @intCast(xstep))));
            }
        }
    } else {
        dd = (@as(c_int, 2) * dx) - dy;
...
pub export fn sbmp16_rect(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    var width: @"u32" = @as(@"u32", @bitCast(right - left));
    _ = &width;
    var height: @"u32" = @as(@"u32", @bitCast(bottom - top));
    _ = &height;
    ...
    while ((blk: {
        ...
        memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width);
        dstL += dstP;
    }
}
pub export fn sbmp16_frame(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    _ = &dstP;
    memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width);
    if (height < @as(@"u32", @bitCast(@as(c_int, 2)))) return;
    dstL += dstP;
    height -%= @as(@"u32", @bitCast(@as(c_int, 2)));
    while ((blk: {
        const ref = &height;
        const tmp = ref.*;
        ref.* -%= 1;
        ...
        dstL[@as(c_uint, @intCast(@as(c_int, 0)))] = @as(pixel_t, @bitCast(@as(c_ushort, @truncate(clr))));
        dstL[width -% @as(@"u32", @bitCast(@as(c_int, 1)))] = @as(pixel_t, @bitCast(@as(c_ushort, @truncate(clr))));
        dstL += dstP;
    }
    memset16(@as(?*anyopaque, @ptrCast(dstL)), @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), width);
}
pub export fn sbmp16_blit(arg_dst: [*c]const TSurface, arg_dstX: c_int, arg_dstY: c_int, arg_width: uint, arg_height: uint, arg_src: [*c]const TSurface, arg_srcX: c_int, arg_srcY: c_int) void {
    var dst = arg_dst;
    _ = &dst;
    var dstX = arg_dstX;
    _ = &dstX;
    ...
    while ((blk: {
        ...
        memcpy16(@as(?*anyopaque, @ptrCast(dstL)), @as(?*const anyopaque, @ptrCast(srcL)), @as(uint, @bitCast(w)));
        srcL += srcP;
        dstL += dstP;
    }
}
pub export fn sbmp16_floodfill(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    sbmp16_floodfill_internal(dst, x, y, @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr)))), clrOld);
}
...
pub export fn sbmp16_floodfill_internal(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clrNew: @"u16", arg_clrOld: @"u16") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    _ = &dstL;
    var dstPitch: @"u32" = @as(@"u32", @bitCast(@as(c_uint, @truncate(@as(c_ulonglong, @bitCast(@as(c_ulonglong, dst.*.pitch))) / @sizeOf(pixel_t)))));
    _ = &dstPitch;
    var dstH: @"u32" = @as(@"u32", @bitCast(@as(c_uint, dst.*.height)));
    _ = &dstH;
    var ii: c_int = undefined;
    _ = &ii;
    var left: c_int = x;
    ...
    memset16(@as(?*anyopaque, @ptrCast(&(blk: {
        const tmp = left;
        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)), clrNew, @as(uint, @bitCast((right + @as(c_int, 1)) - left)));
    {
        ii = left;
        while (ii <= right) : (ii += 1) {
            if ((@as(c_int, @bitCast(@as(c_uint, dstL[@as(@"u32", @bitCast(ii)) -% dstPitch]))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (y > @as(c_int, 0))) {
                sbmp16_floodfill_internal(dst, ii, y - @as(c_int, 1), clrNew, clrOld);
            }
            if ((@as(c_int, @bitCast(@as(c_uint, dstL[@as(@"u32", @bitCast(ii)) +% dstPitch]))) == @as(c_int, @bitCast(@as(c_uint, clrOld)))) and (@as(@"u32", @bitCast(y + @as(c_int, 1))) < dstH)) {
                sbmp16_floodfill_internal(dst, ii, y + @as(c_int, 1), clrNew, clrOld);
            }
        }
    }

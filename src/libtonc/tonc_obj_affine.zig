...
pub extern fn oam_init(obj: [*c]OBJ_ATTR, count: uint) void;
pub fn oam_copy(arg_dst: [*c]OBJ_ATTR, arg_src: [*c]const OBJ_ATTR, arg_count: uint) callconv(.c) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
    var count = arg_count;
    _ = &count;
    memcpy32(@as(?*anyopaque, @ptrCast(dst)), @as(?*const anyopaque, @ptrCast(src)), count *% @as(uint, @bitCast(@as(c_int, 2))));
}
pub fn obj_set_attr(arg_obj: [*c]OBJ_ATTR, arg_a0: @"u16", arg_a1: @"u16", arg_a2: @"u16") callconv(.c) [*c]OBJ_ATTR {
    var obj = arg_obj;
    _ = &obj;
    var a0 = arg_a0;
    _ = &a0;
...
pub fn obj_set_pos(arg_obj: [*c]OBJ_ATTR, arg_x: c_int, arg_y: c_int) callconv(.c) void {
    var obj = arg_obj;
    _ = &obj;
    var x = arg_x;
    _ = &x;
    ...
    _ = &y;
    _ = blk: {
        const tmp = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) & ~@as(c_int, 255)) | ((y << @intCast(0)) & @as(c_int, 255))))));
        obj.*.attr0 = tmp;
        break :blk tmp;
    };
    _ = blk: {
        const tmp = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, obj.*.attr1))) & ~@as(c_int, 511)) | ((x << @intCast(0)) & @as(c_int, 511))))));
        obj.*.attr1 = tmp;
        break :blk tmp;
    };
}
pub fn obj_hide(arg_obj: [*c]OBJ_ATTR) callconv(.c) void {
    var obj = arg_obj;
    _ = &obj;
    _ = blk: {
        const tmp = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) & ~@as(c_int, 768)) | (@as(c_int, 512) & @as(c_int, 768))))));
        obj.*.attr0 = tmp;
        break :blk tmp;
    };
}
pub fn obj_unhide(arg_obj: [*c]OBJ_ATTR, arg_mode: @"u16") callconv(.c) void {
    var obj = arg_obj;
    _ = &obj;
    var mode = arg_mode;
    _ = &mode;
    _ = blk: {
        const tmp = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) & ~@as(c_int, 768)) | (@as(c_int, @bitCast(@as(c_uint, mode))) & @as(c_int, 768))))));
        obj.*.attr0 = tmp;
        break :blk tmp;
    };
}
pub fn obj_get_size(arg_obj: [*c]const OBJ_ATTR) callconv(.c) [*c]const @"u8" {
    var obj = arg_obj;
    _ = &obj;
    return @as([*c]const @"u8", @ptrCast(@alignCast(&oam_sizes[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) >> @intCast(14)))][@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr1))) >> @intCast(14)))][@as(usize, @intCast(0))])));
}
pub fn obj_get_width(arg_obj: [*c]const OBJ_ATTR) callconv(.c) c_int {
    var obj = arg_obj;
    _ = &obj;
    return @as(c_int, @bitCast(@as(c_uint, obj_get_size(obj)[@as(c_uint, @intCast(@as(c_int, 0)))])));
}
pub fn obj_get_height(arg_obj: [*c]const OBJ_ATTR) callconv(.c) c_int {
    var obj = arg_obj;
    _ = &obj;
    return @as(c_int, @bitCast(@as(c_uint, obj_get_size(obj)[@as(c_uint, @intCast(@as(c_int, 1)))])));
}
pub extern fn obj_copy(dst: [*c]OBJ_ATTR, src: [*c]const OBJ_ATTR, count: uint) void;
pub extern fn obj_hide_multi(obj: [*c]OBJ_ATTR, count: uint) void;
pub extern fn obj_unhide_multi(obj: [*c]OBJ_ATTR, mode: @"u16", count: uint) void;
pub export fn obj_aff_copy(arg_dst: [*c]OBJ_AFFINE, arg_src: [*c]const OBJ_AFFINE, arg_count: uint) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
    ...
    {
        ii = 0;
        while (@as(uint, @bitCast(ii)) < count) : (ii += 1) {
            dst.*.pa = src.*.pa;
            dst.*.pb = src.*.pb;
            dst.*.pc = src.*.pc;
            dst.*.pd = src.*.pd;
...
pub fn obj_aff_set(arg_oaff: [*c]OBJ_AFFINE, arg_pa: FIXED, arg_pb: FIXED, arg_pc: FIXED, arg_pd: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var pa = arg_pa;
    _ = &pa;
    ...
    var pd = arg_pd;
    _ = &pd;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(pa))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(pb))));
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(pc))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(pd))));
}
pub fn obj_aff_identity(arg_oaff: [*c]OBJ_AFFINE) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_long, 256)))));
    oaff.*.pb = 0;
    oaff.*.pc = 0;
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, 256)))));
}
pub fn obj_aff_scale(arg_oaff: [*c]OBJ_AFFINE, arg_sx: FIXED, arg_sy: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var sx = arg_sx;
    _ = &sx;
    var sy = arg_sy;
    _ = &sy;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(sx))));
    oaff.*.pb = 0;
    oaff.*.pc = 0;
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(sy))));
}
pub fn obj_aff_shearx(arg_oaff: [*c]OBJ_AFFINE, arg_hx: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var hx = arg_hx;
    _ = &hx;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, 256)))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(hx))));
    oaff.*.pc = 0;
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, 256)))));
}
pub fn obj_aff_sheary(arg_oaff: [*c]OBJ_AFFINE, arg_hy: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var hy = arg_hy;
    _ = &hy;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, 256)))));
    oaff.*.pb = 0;
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(hy))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(@as(c_int, 256)))));
}
pub export fn obj_aff_rotate(arg_oaff: [*c]OBJ_AFFINE, arg_alpha: @"u16") void {
    var oaff = arg_oaff;
    _ = &oaff;
    var alpha = arg_alpha;
    _ = &alpha;
    var ss: c_int = lu_sin(@as(uint, @bitCast(@as(c_uint, alpha)))) >> @intCast(4);
    _ = &ss;
    var cc: c_int = lu_cos(@as(uint, @bitCast(@as(c_uint, alpha)))) >> @intCast(4);
    _ = &cc;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(cc))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(-ss))));
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(ss))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(cc))));
}
pub export fn obj_aff_rotscale(arg_oaff: [*c]OBJ_AFFINE, arg_sx: FIXED, arg_sy: FIXED, arg_alpha: @"u16") void {
    var oaff = arg_oaff;
    _ = &oaff;
    var sx = arg_sx;
    _ = &sx;
    ...
    var alpha = arg_alpha;
    _ = &alpha;
    var ss: c_int = lu_sin(@as(uint, @bitCast(@as(c_uint, alpha))));
    _ = &ss;
    var cc: c_int = lu_cos(@as(uint, @bitCast(@as(c_uint, alpha))));
    _ = &cc;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate((cc * sx) >> @intCast(12)))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate((-ss * sx) >> @intCast(12)))));
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate((ss * sy) >> @intCast(12)))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate((cc * sy) >> @intCast(12)))));
}
pub export fn obj_aff_premul(arg_dst: [*c]OBJ_AFFINE, arg_src: [*c]const OBJ_AFFINE) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
    var tmp_a: FIXED = undefined;
    _ = &tmp_a;
    var tmp_b: FIXED = undefined;
    _ = &tmp_b;
    var tmp_c: FIXED = undefined;
    _ = &tmp_c;
    var tmp_d: FIXED = undefined;
    _ = &tmp_d;
    tmp_a = @as(FIXED, @bitCast(@as(c_int, dst.*.pa)));
    tmp_b = @as(FIXED, @bitCast(@as(c_int, dst.*.pb)));
    tmp_c = @as(FIXED, @bitCast(@as(c_int, dst.*.pc)));
    tmp_d = @as(FIXED, @bitCast(@as(c_int, dst.*.pd)));
    dst.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_int, src.*.pa))) * tmp_a) + (@as(c_int, @bitCast(@as(c_int, src.*.pb))) * tmp_c)) >> @intCast(8)))));
    dst.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_int, src.*.pa))) * tmp_b) + (@as(c_int, @bitCast(@as(c_int, src.*.pb))) * tmp_d)) >> @intCast(8)))));
    dst.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_int, src.*.pc))) * tmp_a) + (@as(c_int, @bitCast(@as(c_int, src.*.pd))) * tmp_c)) >> @intCast(8)))));
    dst.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_int, src.*.pc))) * tmp_b) + (@as(c_int, @bitCast(@as(c_int, src.*.pd))) * tmp_d)) >> @intCast(8)))));
}
pub export fn obj_aff_postmul(arg_dst: [*c]OBJ_AFFINE, arg_src: [*c]const OBJ_AFFINE) void {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
    ...
    tmp_c = @as(FIXED, @bitCast(@as(c_int, dst.*.pc)));
    tmp_d = @as(FIXED, @bitCast(@as(c_int, dst.*.pd)));
    dst.*.pa = @as(s16, @bitCast(@as(c_short, @truncate(((tmp_a * @as(c_int, @bitCast(@as(c_int, src.*.pa)))) + (tmp_b * @as(c_int, @bitCast(@as(c_int, src.*.pc))))) >> @intCast(8)))));
    dst.*.pb = @as(s16, @bitCast(@as(c_short, @truncate(((tmp_a * @as(c_int, @bitCast(@as(c_int, src.*.pb)))) + (tmp_b * @as(c_int, @bitCast(@as(c_int, src.*.pd))))) >> @intCast(8)))));
    dst.*.pc = @as(s16, @bitCast(@as(c_short, @truncate(((tmp_c * @as(c_int, @bitCast(@as(c_int, src.*.pa)))) + (tmp_d * @as(c_int, @bitCast(@as(c_int, src.*.pc))))) >> @intCast(8)))));
    dst.*.pd = @as(s16, @bitCast(@as(c_short, @truncate(((tmp_c * @as(c_int, @bitCast(@as(c_int, src.*.pb)))) + (tmp_d * @as(c_int, @bitCast(@as(c_int, src.*.pd))))) >> @intCast(8)))));
}
pub export fn obj_aff_rotscale2(arg_oaff: [*c]OBJ_AFFINE, arg_as: [*c]const AFF_SRC) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var as = arg_as;
    _ = &as;
    var ss: c_int = lu_sin(@as(uint, @bitCast(@as(c_uint, as.*.alpha))));
    _ = &ss;
    var cc: c_int = lu_cos(@as(uint, @bitCast(@as(c_uint, as.*.alpha))));
    _ = &cc;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate((cc * @as(c_int, @bitCast(@as(c_int, as.*.sx)))) >> @intCast(12)))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate((-ss * @as(c_int, @bitCast(@as(c_int, as.*.sx)))) >> @intCast(12)))));
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate((ss * @as(c_int, @bitCast(@as(c_int, as.*.sy)))) >> @intCast(12)))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate((cc * @as(c_int, @bitCast(@as(c_int, as.*.sy)))) >> @intCast(12)))));
}
pub export fn obj_rotscale_ex(arg_obj: [*c]OBJ_ATTR, arg_oaff: [*c]OBJ_AFFINE, arg_asx: [*c]const AFF_SRC_EX) void {
    var obj = arg_obj;
    _ = &obj;
    var oaff = arg_oaff;
    _ = &oaff;
    var asx = arg_asx;
    _ = &asx;
    var sx: c_int = @as(c_int, @bitCast(@as(c_int, asx.*.sx)));
    _ = &sx;
    var sy: c_int = @as(c_int, @bitCast(@as(c_int, asx.*.sy)));
    _ = &sy;
    var sina: c_int = lu_sin(@as(uint, @bitCast(@as(c_uint, asx.*.alpha)))) >> @intCast(4);
    _ = &sina;
    var cosa: c_int = lu_cos(@as(uint, @bitCast(@as(c_uint, asx.*.alpha)))) >> @intCast(4);
    _ = &cosa;
    oaff.*.pa = @as(s16, @bitCast(@as(c_short, @truncate((sx * cosa) >> @intCast(8)))));
    oaff.*.pb = @as(s16, @bitCast(@as(c_short, @truncate((-sx * sina) >> @intCast(8)))));
    oaff.*.pc = @as(s16, @bitCast(@as(c_short, @truncate((sy * sina) >> @intCast(8)))));
    oaff.*.pd = @as(s16, @bitCast(@as(c_short, @truncate((sy * cosa) >> @intCast(8)))));
    sx = Div(@as(c_int, 1) << @intCast(20), sx);
    if (sx != sy) {
        sy = Div(@as(c_int, 1) << @intCast(20), sy);
    } else {
        sy = sx;
    }
    var aa: FIXED = undefined;
    _ = &aa;
    var ab: FIXED = undefined;
    _ = &ab;
    var ac: FIXED = undefined;
    _ = &ac;
    var ad: FIXED = undefined;
    _ = &ad;
    aa = (sx * cosa) >> @intCast(12);
    ab = (sy * sina) >> @intCast(12);
    ac = (-sx * sina) >> @intCast(12);
    ad = (sy * cosa) >> @intCast(12);
    sx = @as(c_int, @bitCast(@as(c_uint, oam_sizes[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) >> @intCast(14)))][@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr1))) >> @intCast(14)))][@as(c_uint, @intCast(@as(c_int, 0)))])));
    sy = @as(c_int, @bitCast(@as(c_uint, oam_sizes[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) >> @intCast(14)))][@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.attr1))) >> @intCast(14)))][@as(c_uint, @intCast(@as(c_int, 1)))])));
    var dx: c_int = @as(c_int, @bitCast(@as(c_int, asx.*.scr_x)));
    _ = &dx;
    var dy: c_int = @as(c_int, @bitCast(@as(c_int, asx.*.scr_y)));
    _ = &dy;
    if ((@as(c_int, @bitCast(@as(c_uint, obj.*.attr0))) & @as(c_int, 512)) != 0) {
        dx -= sx;
        dy -= sy;
    } else {
        dx -= sx >> @intCast(1);
    ...
    sx = asx.*.tex_x - (sx << @intCast(7));
    sy = asx.*.tex_y - (sy << @intCast(7));
    dx -= ((aa * sx) + (ab * sy)) >> @intCast(16);
    dy -= ((ac * sx) + (ad * sy)) >> @intCast(16);
    obj_set_pos(obj, dx, dy);
}
pub fn obj_aff_scale_inv(arg_oaff: [*c]OBJ_AFFINE, arg_wx: FIXED, arg_wy: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var wx = arg_wx;
    _ = &wx;
    var wy = arg_wy;
    _ = &wy;
    obj_aff_scale(oaff, @divTrunc(@as(c_int, 1) << @intCast(24), wx) >> @intCast(8), @divTrunc(@as(c_int, 1) << @intCast(24), wy) >> @intCast(8));
}
pub fn obj_aff_rotate_inv(arg_oaff: [*c]OBJ_AFFINE, arg_theta: @"u16") callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var theta = arg_theta;
    _ = &theta;
    obj_aff_rotate(oaff, @as(@"u16", @bitCast(@as(c_short, @truncate(-@as(c_int, @bitCast(@as(c_uint, theta))))))));
}
pub fn obj_aff_shearx_inv(arg_oaff: [*c]OBJ_AFFINE, arg_hx: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var hx = arg_hx;
    _ = &hx;
...
pub fn obj_aff_sheary_inv(arg_oaff: [*c]OBJ_AFFINE, arg_hy: FIXED) callconv(.c) void {
    var oaff = arg_oaff;
    _ = &oaff;
    var hy = arg_hy;
    _ = &hy;
...
pub const TONC_OAM = "";
pub inline fn OAM_CLEAR() @TypeOf(memset32(oam_mem, @as(c_int, 0), @import("std").zig.c_translation.MacroArithmetic.div(OAM_SIZE, @as(c_int, 4)))) {
    return memset32(oam_mem, @as(c_int, 0), @import("std").zig.c_translation.MacroArithmetic.div(OAM_SIZE, @as(c_int, 4)));
}

...
pub const KI_A: c_int = 0;
pub const KI_B: c_int = 1;
pub const KI_SELECT: c_int = 2;
pub const KI_START: c_int = 3;
pub const KI_RIGHT: c_int = 4;
pub const KI_LEFT: c_int = 5;
pub const KI_UP: c_int = 6;
pub const KI_DOWN: c_int = 7;
pub const KI_R: c_int = 8;
pub const KI_L: c_int = 9;
pub const KI_MAX: c_int = 10;
pub const enum_eKeyIndex = c_uint;
pub const eKeyIndex = enum_eKeyIndex;
pub extern var __key_curr: @"u16";
pub extern var __key_prev: @"u16";
pub extern fn key_wait_for_clear(key: @"u32") void;
pub const struct_REPEAT_REC = extern struct {
    keys: @"u16" = @import("std").mem.zeroes(@"u16"),
    mask: @"u16" = @import("std").mem.zeroes(@"u16"),
    count: @"u8" = @import("std").mem.zeroes(@"u8"),
    delay: @"u8" = @import("std").mem.zeroes(@"u8"),
    repeat: @"u8" = @import("std").mem.zeroes(@"u8"),
};
pub const REPEAT_REC = struct_REPEAT_REC;
pub export fn key_poll() void {
    __key_prev = __key_curr;
    __key_curr = @as(@"u16", @bitCast(@as(c_short, @truncate(~@as(c_int, @bitCast(@as(c_uint, @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 304))).*))) & @as(c_int, 1023)))));
    var rpt: [*c]REPEAT_REC = &__key_rpt;
    _ = &rpt;
    rpt.*.keys = 0;
    if (rpt.*.delay != 0) {
        if (key_transit(@as(@"u32", @bitCast(@as(c_uint, rpt.*.mask)))) != 0) {
            rpt.*.count = rpt.*.delay;
            rpt.*.keys = __key_curr;
        } else {
            rpt.*.count -%= 1;
        }
        if (@as(c_int, @bitCast(@as(c_uint, rpt.*.count))) == @as(c_int, 0)) {
            rpt.*.count = rpt.*.repeat;
            rpt.*.keys = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, __key_curr))) & @as(c_int, @bitCast(@as(c_uint, rpt.*.mask)))))));
        }
    }
}
pub fn key_curr_state() callconv(.c) @"u32" {
    return @as(@"u32", @bitCast(@as(c_uint, __key_curr)));
}
pub fn key_prev_state() callconv(.c) @"u32" {
    return @as(@"u32", @bitCast(@as(c_uint, __key_prev)));
}
pub fn key_is_down(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(@as(c_uint, __key_curr))) & key;
}
pub fn key_is_up(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(~@as(c_int, @bitCast(@as(c_uint, __key_curr))))) & key;
}
pub fn key_was_down(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(@as(c_uint, __key_prev))) & key;
}
pub fn key_was_up(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(~@as(c_int, @bitCast(@as(c_uint, __key_prev))))) & key;
}
pub fn key_transit(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, __key_curr))) ^ @as(c_int, @bitCast(@as(c_uint, __key_prev))))) & key;
}
pub fn key_held(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, __key_curr))) & @as(c_int, @bitCast(@as(c_uint, __key_prev))))) & key;
}
pub fn key_hit(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, __key_curr))) & ~@as(c_int, @bitCast(@as(c_uint, __key_prev))))) & key;
}
pub fn key_released(arg_key: @"u32") callconv(.c) @"u32" {
    var key = arg_key;
    _ = &key;
    return @as(@"u32", @bitCast(~@as(c_int, @bitCast(@as(c_uint, __key_curr))) & @as(c_int, @bitCast(@as(c_uint, __key_prev))))) & key;
}
pub fn key_tri_horz() callconv(.c) c_int {
    return bit_tribool(@as(@"u32", @bitCast(@as(c_uint, __key_curr))), @as(uint, @bitCast(KI_RIGHT)), @as(uint, @bitCast(KI_LEFT)));
}
pub fn key_tri_vert() callconv(.c) c_int {
    return bit_tribool(@as(@"u32", @bitCast(@as(c_uint, __key_curr))), @as(uint, @bitCast(KI_DOWN)), @as(uint, @bitCast(KI_UP)));
}
pub fn key_tri_shoulder() callconv(.c) c_int {
    return bit_tribool(@as(@"u32", @bitCast(@as(c_uint, __key_curr))), @as(uint, @bitCast(KI_R)), @as(uint, @bitCast(KI_L)));
}
pub fn key_tri_fire() callconv(.c) c_int {
    return bit_tribool(@as(@"u32", @bitCast(@as(c_uint, __key_curr))), @as(uint, @bitCast(KI_A)), @as(uint, @bitCast(KI_B)));
}
pub export fn key_repeat(arg_keys: @"u32") @"u32" {
    var keys = arg_keys;
    _ = &keys;
    return @as(@"u32", @bitCast(@as(c_uint, __key_rpt.keys))) & keys;
}
pub export fn key_repeat_mask(arg_mask: @"u32") void {
    var mask = arg_mask;
    _ = &mask;
    __key_rpt.mask = @as(@"u16", @bitCast(@as(c_ushort, @truncate(mask & @as(@"u32", @bitCast(@as(c_int, 1023)))))));
}
pub export fn key_repeat_limits(arg_delay: uint, arg_repeat: uint) void {
    var delay = arg_delay;
    _ = &delay;
    ...
    var rpt: [*c]REPEAT_REC = &__key_rpt;
    _ = &rpt;
    if (delay >= @as(uint, @bitCast(@as(c_int, 0)))) {
        rpt.*.delay = @as(@"u8", @bitCast(@as(u8, @truncate(delay))));
    }
    if (repeat >= @as(uint, @bitCast(@as(c_int, 0)))) {
        rpt.*.repeat = @as(@"u8", @bitCast(@as(u8, @truncate(repeat))));
    }
    rpt.*.count = @as(@"u8", @bitCast(@as(u8, @truncate(delay))));
}
pub export fn key_wait_till_hit(arg_key: @"u16") void {
    var key = arg_key;
    _ = &key;
    while (true) {
        VBlankIntrWait();
        key_poll();
        if (key_hit(@as(@"u32", @bitCast(@as(c_uint, key)))) != 0) return;
    }
}
...
pub export var __key_rpt: REPEAT_REC = REPEAT_REC{
    .keys = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 0))))),
    .mask = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1023))))),
    .count = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 60))))),
    .delay = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 60))))),
    .repeat = @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 30))))),
};
...
pub const KEY_FULL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xFFFFFFFF, .hex);
pub inline fn KEY_DOWN_NOW(key: anytype) @TypeOf(~REG_KEYINPUT & key) {
    _ = &key;
    return ~REG_KEYINPUT & key;
}
pub inline fn KEY_UP_NOW(key: anytype) @TypeOf(REG_KEYINPUT & key) {
    _ = &key;
    return REG_KEYINPUT & key;
}
pub inline fn KEY_EQ(key_fun: anytype, keys: anytype) @TypeOf(key_fun(keys) == keys) {
    _ = &key_fun;
    _ = &keys;
    return key_fun(keys) == keys;
}
pub inline fn KEY_TRIBOOL(fnKey: anytype, plus: anytype, minus: anytype) @TypeOf(bit_tribool(fnKey(KEY_FULL), plus, minus)) {
    _ = &fnKey;
    _ = &plus;
    _ = &minus;

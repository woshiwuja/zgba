...
pub export fn tonccpy(arg_dst: ?*anyopaque, arg_src: ?*const anyopaque, arg_size: uint) ?*anyopaque {
    var dst = arg_dst;
    _ = &dst;
    var src = arg_src;
    _ = &src;
    var size = arg_size;
    _ = &size;
    if (((size == @as(uint, @bitCast(@as(c_int, 0)))) or (dst == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))) or (src == @as(?*const anyopaque, @ptrCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return dst;
    var count: uint = undefined;
    _ = &count;
    var dst16: [*c]@"u16" = undefined;
    _ = &dst16;
    var src8: [*c]@"u8" = undefined;
    _ = &src8;
    if ((((@as(@"u32", @intCast(@intFromPtr(src))) | @as(@"u32", @intCast(@intFromPtr(dst)))) % @as(@"u32", @bitCast(@as(c_int, 4)))) == @as(@"u32", @bitCast(@as(c_int, 0)))) and (size >= @as(uint, @bitCast(@as(c_int, 4))))) {
        var src32: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@volatileCast(@constCast(src))));
        _ = &src32;
        var dst32: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(dst)));
        _ = &dst32;
        count = size / @as(uint, @bitCast(@as(c_int, 4)));
        var tmp: uint = count & @as(uint, @bitCast(@as(c_int, 3)));
        _ = &tmp;
        count /= @as(uint, @bitCast(@as(c_int, 4)));
        while (true) {
            switch (tmp) {
                else => {},
            }
        ...
        size &= @as(uint, @bitCast(@as(c_int, 3)));
        if (size == @as(uint, @bitCast(@as(c_int, 0)))) return dst;
        src8 = @as([*c]@"u8", @ptrCast(@alignCast(src32)));
        dst16 = @as([*c]@"u16", @ptrCast(@alignCast(dst32)));
    } else {
        var dstOfs: uint = @as(@"u32", @intCast(@intFromPtr(dst))) & @as(@"u32", @bitCast(@as(c_int, 1)));
        _ = &dstOfs;
        src8 = @as([*c]@"u8", @ptrCast(@volatileCast(@constCast(src))));
        dst16 = @as([*c]@"u16", @ptrCast(@alignCast(dst - dstOfs)));
        if (dstOfs != @as(uint, @bitCast(@as(c_int, 0)))) {
            dst16.* = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, dst16.*))) & @as(c_int, 255)) | (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const ref = &src8;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
            ...
            if ((blk: {
                ...
                ref.* -%= 1;
                break :blk ref.*;
            }) == @as(uint, @bitCast(@as(c_int, 0)))) return dst;
        }
    }
    count = size / @as(uint, @bitCast(@as(c_int, 2)));
    while ((blk: {
        const ref = &count;
        const tmp = ref.*;
        ref.* -%= 1;
        ...
        (blk: {
            ...
            ref.* += 1;
            break :blk tmp;
        }).* = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, src8[@as(c_uint, @intCast(@as(c_int, 0)))]))) | (@as(c_int, @bitCast(@as(c_uint, src8[@as(c_uint, @intCast(@as(c_int, 1)))]))) << @intCast(8))))));
        src8 += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))));
    }
    if ((size & @as(uint, @bitCast(@as(c_int, 1)))) != 0) {
        dst16.* = @as(@"u16", @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, dst16.*))) & ~@as(c_int, 255)) | @as(c_int, @bitCast(@as(c_uint, src8.*)))))));
    }
    return dst;
}
pub export fn __toncset(arg_dst: ?*anyopaque, arg_fill: @"u32", arg_size: uint) ?*anyopaque {
    var dst = arg_dst;
    _ = &dst;
    var fill = arg_fill;
    _ = &fill;
    var size = arg_size;
    _ = &size;
    if ((dst == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) or (size == @as(uint, @bitCast(@as(c_int, 0))))) return dst;
    var left: uint = @as(@"u32", @intCast(@intFromPtr(dst))) & @as(@"u32", @bitCast(@as(c_int, 3)));
    _ = &left;
    var dst32: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(dst - left)));
    _ = &dst32;
    ...
    if (left != @as(uint, @bitCast(@as(c_int, 0)))) {
        if ((left +% size) < @as(uint, @bitCast(@as(c_int, 4)))) {
            mask = @as(@"u32", @bitCast(((@as(c_int, 1) << @intCast(size *% @as(uint, @bitCast(@as(c_int, 8))))) - @as(c_int, 1)) << @intCast(left *% @as(uint, @bitCast(@as(c_int, 8))))));
            dst32.* = (dst32.* & ~mask) | (fill & mask);
            return dst;
        }
        mask = @as(@"u32", @bitCast((@as(c_int, 1) << @intCast(left *% @as(uint, @bitCast(@as(c_int, 8))))) - @as(c_int, 1)));
        dst32.* = (dst32.* & mask) | (fill & ~mask);
        dst32 += 1;
        size -%= @as(uint, @bitCast(@as(c_int, 4))) -% left;
    }
    count = size / @as(uint, @bitCast(@as(c_int, 4)));
    var tmp: uint = count & @as(@"u32", @bitCast(@as(c_int, 3)));
    _ = &tmp;
    count /= @as(@"u32", @bitCast(@as(c_int, 4)));
    while (true) {
        switch (tmp) {
            else => {},
        }
    ...
    size &= @as(uint, @bitCast(@as(c_int, 3)));
    if (size != 0) {
        mask = @as(@"u32", @bitCast((@as(c_int, 1) << @intCast(size *% @as(uint, @bitCast(@as(c_int, 8))))) - @as(c_int, 1)));
        dst32.* = (dst32.* & ~mask) | (fill & mask);
    }
    return dst;
}
...
pub export fn octant(arg_x: c_int, arg_y: c_int) @"u32" {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    _ = &oct;
    if (y < @as(c_int, 0)) {
        oct ^= @as(@"u32", @bitCast(@as(c_int, 7)));
        y = -y;
    }
    if (x < @as(c_int, 0)) {
        oct ^= @as(@"u32", @bitCast(@as(c_int, 3)));
        x = -x;
    }
    if (x < y) {
        oct ^= @as(@"u32", @bitCast(@as(c_int, 1)));
    }
    return oct;
}
pub export fn octant_rot(arg_x0: c_int, arg_y0: c_int) @"u32" {
    var x0 = arg_x0;
    _ = &x0;
    var y0 = arg_y0;
    _ = &y0;
    var x: c_int = (@as(c_int, 473) * x0) - (@as(c_int, 196) * y0);
    _ = &x;
    var y: c_int = (@as(c_int, 196) * x0) + (@as(c_int, 473) * y0);
    _ = &y;
    var oct: @"u32" = 0;
    _ = &oct;
    if (y < @as(c_int, 0)) {
...
pub export fn sqran(arg_seed: c_int) c_int {
    var seed = arg_seed;
    _ = &seed;
    var old: c_int = __qran_seed;
    _ = &old;
    __qran_seed = seed;
    return old;
}

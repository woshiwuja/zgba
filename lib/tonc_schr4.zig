...
pub const SRF_NONE: c_int = 0;
pub const SRF_BMP16: c_int = 1;
pub const SRF_BMP8: c_int = 2;
pub const SRF_CHR4R: c_int = 4;
pub const SRF_CHR4C: c_int = 5;
pub const SRF_CHR8: c_int = 6;
pub const SRF_ALLOCATED: c_int = 128;
pub const enum_ESurfaceType = c_uint;
pub const ESurfaceType = enum_ESurfaceType;
pub const struct_TSurface = extern struct {
    ...
    palSize: @"u16" = @import("std").mem.zeroes(@"u16"),
    palData: [*c]@"u16" = @import("std").mem.zeroes([*c]@"u16"),
};
pub const TSurface = struct_TSurface;
pub const fnGetPixel = ?*const fn ([*c]const TSurface, c_int, c_int) callconv(.c) @"u32";
pub const fnPlot = ?*const fn ([*c]const TSurface, c_int, c_int, @"u32") callconv(.c) void;
pub const fnHLine = ?*const fn ([*c]const TSurface, c_int, c_int, c_int, @"u32") callconv(.c) void;
pub const fnVLine = ?*const fn ([*c]const TSurface, c_int, c_int, c_int, @"u32") callconv(.c) void;
pub const fnLine = ?*const fn ([*c]const TSurface, c_int, c_int, c_int, c_int, @"u32") callconv(.c) void;
pub const fnRect = ?*const fn ([*c]const TSurface, c_int, c_int, c_int, c_int, @"u32") callconv(.c) void;
pub const fnFrame = ?*const fn ([*c]const TSurface, c_int, c_int, c_int, c_int, @"u32") callconv(.c) void;
pub const fnBlit = ?*const fn ([*c]const TSurface, c_int, c_int, uint, uint, [*c]const TSurface, c_int, c_int) callconv(.c) void;
pub const fnFlood = ?*const fn ([*c]const TSurface, c_int, c_int, @"u32") callconv(.c) void;
pub const struct_TSurfaceProcTab = extern struct {
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    getPixel: fnGetPixel = @import("std").mem.zeroes(fnGetPixel),
    plot: fnPlot = @import("std").mem.zeroes(fnPlot),
    hline: fnHLine = @import("std").mem.zeroes(fnHLine),
    vline: fnVLine = @import("std").mem.zeroes(fnVLine),
    line: fnLine = @import("std").mem.zeroes(fnLine),
    rect: fnRect = @import("std").mem.zeroes(fnRect),
    frame: fnFrame = @import("std").mem.zeroes(fnFrame),
    blit: fnBlit = @import("std").mem.zeroes(fnBlit),
    flood: fnFlood = @import("std").mem.zeroes(fnFlood),
};
pub const TSurfaceProcTab = struct_TSurfaceProcTab;
pub extern const m3_surface: TSurface;
pub extern var m4_surface: TSurface linksection(".ewram");
pub extern var m5_surface: TSurface linksection(".ewram");
pub extern const bmp16_tab: TSurfaceProcTab;
pub extern const bmp8_tab: TSurfaceProcTab;
pub extern const chr4c_tab: TSurfaceProcTab;
pub extern fn srf_init(srf: [*c]TSurface, @"type": enum_ESurfaceType, data: ?*const anyopaque, width: uint, height: uint, bpp: uint, pal: [*c]@"u16") void;
pub extern fn srf_pal_copy(dst: [*c]const TSurface, src: [*c]const TSurface, count: uint) void;
pub extern fn srf_get_ptr(srf: [*c]const TSurface, x: uint, y: uint) ?*anyopaque;
pub fn srf_align(arg_width: uint, arg_bpp: uint) callconv(.c) uint {
    var width = arg_width;
    _ = &width;
    var bpp = arg_bpp;
    _ = &bpp;
    return (((width *% bpp) +% @as(uint, @bitCast(@as(c_int, 31)))) / @as(uint, @bitCast(@as(c_int, 32)))) *% @as(uint, @bitCast(@as(c_int, 4)));
}
pub fn srf_set_ptr(arg_srf: [*c]TSurface, arg_ptr: ?*const anyopaque) callconv(.c) void {
    var srf = arg_srf;
    _ = &srf;
    var ptr = arg_ptr;
    _ = &ptr;
    srf.*.data = @as([*c]@"u8", @ptrCast(@volatileCast(@constCast(ptr))));
}
pub fn srf_set_pal(arg_srf: [*c]TSurface, arg_pal: [*c]const @"u16", arg_size: uint) callconv(.c) void {
    var srf = arg_srf;
    _ = &srf;
    var pal = arg_pal;
    _ = &pal;
    var size = arg_size;
    _ = &size;
    srf.*.palSize = @as(@"u16", @bitCast(@as(c_ushort, @truncate(size))));
    srf.*.palData = @as([*c]@"u16", @ptrCast(@volatileCast(@constCast(pal))));
}
pub fn _srf_get_ptr(arg_srf: [*c]const TSurface, arg_x: uint, arg_y: uint, arg_stride: uint) callconv(.c) ?*anyopaque {
    var srf = arg_srf;
    _ = &srf;
    var x = arg_x;
    _ = &x;
    ...
    _ = &stride;
    return @as(?*anyopaque, @ptrCast((srf.*.data + (y *% srf.*.pitch)) + (x *% stride)));
}
pub extern fn sbmp16_get_pixel(src: [*c]const TSurface, x: c_int, y: c_int) @"u32";
pub extern fn sbmp16_plot(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub extern fn sbmp16_hline(dst: [*c]const TSurface, x1: c_int, y: c_int, x2: c_int, clr: @"u32") void;
pub extern fn sbmp16_vline(dst: [*c]const TSurface, x: c_int, y1: c_int, y2: c_int, clr: @"u32") void;
pub extern fn sbmp16_line(dst: [*c]const TSurface, x1: c_int, y1: c_int, x2: c_int, y2: c_int, clr: @"u32") void;
pub extern fn sbmp16_rect(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn sbmp16_frame(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn sbmp16_blit(dst: [*c]const TSurface, dstX: c_int, dstY: c_int, width: uint, height: uint, src: [*c]const TSurface, srcX: c_int, srcY: c_int) void;
pub extern fn sbmp16_floodfill(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub export fn _sbmp16_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var dstD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch))));
    _ = &dstD;
    (blk: {
        const tmp = x;
        if (tmp >= 0) break :blk dstD + @as(usize, @intCast(tmp)) else break :blk dstD - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(clr))));
}
pub export fn _sbmp16_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    var srcD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast(src.*.data + (@as(@"u32", @bitCast(y)) *% src.*.pitch))));
    _ = &srcD;
    return @as(@"u32", @bitCast(@as(c_uint, (blk: {
        const tmp = x;
        if (tmp >= 0) break :blk srcD + @as(usize, @intCast(tmp)) else break :blk srcD - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
}
pub extern fn sbmp8_get_pixel(src: [*c]const TSurface, x: c_int, y: c_int) @"u32";
pub extern fn sbmp8_plot(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub extern fn sbmp8_hline(dst: [*c]const TSurface, x1: c_int, y: c_int, x2: c_int, clr: @"u32") void;
pub extern fn sbmp8_vline(dst: [*c]const TSurface, x: c_int, y1: c_int, y2: c_int, clr: @"u32") void;
pub extern fn sbmp8_line(dst: [*c]const TSurface, x1: c_int, y1: c_int, x2: c_int, y2: c_int, clr: @"u32") void;
pub extern fn sbmp8_rect(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn sbmp8_frame(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn sbmp8_blit(dst: [*c]const TSurface, dstX: c_int, dstY: c_int, width: uint, height: uint, src: [*c]const TSurface, srcX: c_int, srcY: c_int) void;
pub extern fn sbmp8_floodfill(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub fn _sbmp8_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") callconv(.c) void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var dstD: [*c]@"u16" = @as([*c]@"u16", @ptrCast(@alignCast((dst.*.data + (@as(@"u32", @bitCast(y)) *% dst.*.pitch)) + @as(usize, @bitCast(@as(isize, @intCast(x & ~@as(c_int, 1))))))));
    _ = &dstD;
    if ((x & @as(c_int, 1)) != 0) {
        dstD.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstD.*))) & @as(c_int, 255))) | (clr << @intCast(8))))));
    } else {
        dstD.* = @as(@"u16", @bitCast(@as(c_ushort, @truncate(@as(@"u32", @bitCast(@as(c_int, @bitCast(@as(c_uint, dstD.*))) & ~@as(c_int, 255))) | (clr & @as(@"u32", @bitCast(@as(c_int, 255))))))));
    }
}
pub fn _sbmp8_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) callconv(.c) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    return @as(@"u32", @bitCast(@as(c_uint, src.*.data[(@as(@"u32", @bitCast(y)) *% src.*.pitch) +% @as(@"u32", @bitCast(x))])));
}
pub export fn schr4c_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    var srcD: [*c]@"u32" = schr4c_get_ptr(src, x, y);
    _ = &srcD;
    var shift: uint = @as(uint, @bitCast((x & @as(c_int, 7)) * @as(c_int, 4)));
    _ = &shift;
    return (srcD.* >> @intCast(shift)) & @as(@"u32", @bitCast(@as(c_int, 15)));
}
pub export fn schr4c_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var xx: uint = @as(uint, @bitCast(x));
    _ = &xx;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(dst.*.data + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% dst.*.pitch))));
    _ = &dstD;
    var shift: uint = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    (blk: {
        const tmp = y;
        if (tmp >= 0) break :blk dstD + @as(usize, @intCast(tmp)) else break :blk dstD - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        ...
        const tmp = y;
        if (tmp >= 0) break :blk dstD + @as(usize, @intCast(tmp)) else break :blk dstD - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* & @as(@"u32", @bitCast(~(@as(c_int, 15) << @intCast(shift))))) | ((clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift));
}
pub export fn schr4c_hline(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y: c_int, arg_x2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    var dstL: [*c]@"u32" = schr4c_get_ptr(dst, x1, y);
    _ = &dstL;
    var dstP: @"u32" = dst.*.pitch / @as(@"u32", @bitCast(@as(c_int, 4)));
    _ = &dstP;
    clr = octup(@as(@"u8", @bitCast(@as(u8, @truncate(clr & @as(@"u32", @bitCast(@as(c_int, 15))))))));
    var width: uint = @as(uint, @bitCast((x2 - x1) + @as(c_int, 1)));
    _ = &width;
    var left: uint = @as(uint, @bitCast(x1 & @as(c_int, 7)));
    _ = &left;
    var maskL: @"u32" = chr4_lmask(@as(uint, @bitCast(x1)));
    _ = &maskL;
    var maskR: @"u32" = chr4_rmask(@as(uint, @bitCast(x2 + @as(c_int, 1))));
    _ = &maskR;
    if ((left +% width) <= @as(uint, @bitCast(@as(c_int, 8)))) {
        var mask: @"u32" = maskL & maskR;
        _ = &mask;
        dstL.* = (dstL.* & ~mask) | (clr & mask);
        return;
    }
    if (left != @as(uint, @bitCast(@as(c_int, 0)))) {
        dstL.* = (dstL.* & ~maskL) | (clr & maskL);
        width -%= @as(uint, @bitCast(@as(c_int, 8))) -% left;
        dstL += dstP;
    }
    if ((width & @as(uint, @bitCast(@as(c_int, 7)))) != 0) {
        width &= @as(uint, @bitCast(~@as(c_int, 7)));
        dstL[(width / @as(uint, @bitCast(@as(c_int, 8)))) *% dstP] = (dstL[(width / @as(uint, @bitCast(@as(c_int, 8)))) *% dstP] & ~maskR) | (clr & maskR);
    }
    while (width != 0) {
        dstL.* = clr;
        dstL += dstP;
        width -%= @as(uint, @bitCast(@as(c_int, 8)));
    }
}
pub export fn schr4c_vline(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y1: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var dstL: [*c]@"u32" = schr4c_get_ptr(dst, x, y1);
    _ = &dstL;
    var height: uint = @as(uint, @bitCast((y2 - y1) + @as(c_int, 1)));
    _ = &height;
    var shift: uint = @as(uint, @bitCast((x & @as(c_int, 7)) * @as(c_int, 4)));
    _ = &shift;
    var mask: @"u32" = @as(@"u32", @bitCast(@as(c_int, 15) << @intCast(shift)));
    _ = &mask;
    clr = (clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift);
    while ((blk: {
        const ref = &height;
        const tmp = ref.*;
        ref.* -%= 1;
...
pub export fn schr4c_line(arg_dst: [*c]const TSurface, arg_x1: c_int, arg_y1: c_int, arg_x2: c_int, arg_y2: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x1 = arg_x1;
    _ = &x1;
    ...
    _ = &dy;
    var xstep: c_int = undefined;
    _ = &xstep;
    var ystep: c_int = undefined;
    _ = &ystep;
    var dd: c_int = undefined;
    _ = &dd;
    if (x1 > x2) {
        xstep = -@as(c_int, 1);
        dx = x1 - x2;
    ...
    if (dx >= dy) {
        dd = (@as(c_int, 2) * dy) - dx;
        {
            ii = 0;
            while (ii <= dx) : (ii += 1) {
                chr4c_plot(x1, y1, clr, @as(?*anyopaque, @ptrCast(dst.*.data)), dst.*.pitch);
                if (dd >= @as(c_int, 0)) {
                    dd -= @as(c_int, 2) * dx;
                    y1 += ystep;
                }
...
pub export fn schr4c_rect(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    clr = octup(@as(@"u8", @bitCast(@as(u8, @truncate(clr & @as(@"u32", @bitCast(@as(c_int, 15))))))));
    var width: uint = @as(uint, @bitCast(right - left));
    _ = &width;
    var height: uint = @as(uint, @bitCast(bottom - top));
    _ = &height;
    var dstP: uint = dst.*.pitch / @as(@"u32", @bitCast(@as(c_int, 4)));
    _ = &dstP;
    var dstD: [*c]@"u32" = schr4c_get_ptr(dst, left, top);
    _ = &dstD;
    if (((left | right) & @as(c_int, 7)) != 0) {
        var x0: uint = @as(uint, @bitCast(left & @as(c_int, 7)));
        _ = &x0;
        if (x0 != @as(uint, @bitCast(@as(c_int, 0)))) {
            right = min(@as(c_int, @bitCast(x0 +% width)), @as(c_int, 8));
            chr4c_colset(dstD, x0, @as(uint, @bitCast(right)), height, clr);
            width -%= @as(uint, @bitCast(right)) -% x0;
            dstD += dstP;
        }
        if ((width & @as(uint, @bitCast(@as(c_int, 7)))) != 0) {
            chr4c_colset(&dstD[(width / @as(uint, @bitCast(@as(c_int, 8)))) *% dstP], @as(uint, @bitCast(@as(c_int, 0))), width & @as(uint, @bitCast(@as(c_int, 7))), height, clr);
            width &= @as(uint, @bitCast(~@as(c_int, 7)));
        }
    }
    while (width != 0) {
        memset32(@as(?*anyopaque, @ptrCast(dstD)), clr, height);
        dstD += dstP;
        width -%= @as(uint, @bitCast(@as(c_int, 8)));
    }
    return;
}
pub export fn schr4c_frame(arg_dst: [*c]const TSurface, arg_left: c_int, arg_top: c_int, arg_right: c_int, arg_bottom: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var left = arg_left;
    _ = &left;
    ...
    var height: uint = @as(uint, @bitCast(bottom - top));
    _ = &height;
    schr4c_hline(dst, left, top, right - @as(c_int, 1), clr);
    if (height == @as(uint, @bitCast(@as(c_int, 1)))) return;
    schr4c_hline(dst, left, bottom - @as(c_int, 1), right - @as(c_int, 1), clr);
    if (height > @as(uint, @bitCast(@as(c_int, 2)))) {
        schr4c_vline(dst, left, top, bottom - @as(c_int, 1), clr);
        schr4c_vline(dst, right - @as(c_int, 1), top, bottom - @as(c_int, 1), clr);
    }
}
pub export fn schr4c_blit(arg_dst: [*c]const TSurface, arg_dstX: c_int, arg_dstY: c_int, arg_width: uint, arg_height: uint, arg_src: [*c]const TSurface, arg_srcX: c_int, arg_srcY: c_int) void {
    var dst = arg_dst;
    _ = &dst;
    var dstX = arg_dstX;
    _ = &dstX;
    ...
    var srcY = arg_srcY;
    _ = &srcY;
    if ((((src == @as([*c]const TSurface, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (dst == @as([*c]const TSurface, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (src.*.data == @as([*c]@"u8", @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (dst.*.data == @as([*c]@"u8", @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return;
    var w: c_int = @as(c_int, @bitCast(width));
    _ = &w;
    var h: c_int = @as(c_int, @bitCast(height));
    _ = &h;
    while (true) {
        if ((dstX >= @as(c_int, @bitCast(@as(c_uint, dst.*.width)))) or ((dstX + w) <= @as(c_int, 0))) return;
        if (dstX < @as(c_int, 0)) {
            w += dstX;
            srcX += dstX;
            dstX = 0;
        }
        if (w > (@as(c_int, @bitCast(@as(c_uint, dst.*.width))) - dstX)) {
            w = @as(c_int, @bitCast(@as(c_uint, dst.*.width))) - dstX;
        }
        if (!false) break;
    }
    while (true) {
        if ((srcX >= @as(c_int, @bitCast(@as(c_uint, src.*.width)))) or ((srcX + w) <= @as(c_int, 0))) return;
        if (srcX < @as(c_int, 0)) {
            w += srcX;
            dstX += srcX;
            srcX = 0;
        }
        if (w > (@as(c_int, @bitCast(@as(c_uint, src.*.width))) - srcX)) {
            w = @as(c_int, @bitCast(@as(c_uint, src.*.width))) - srcX;
        }
        if (!false) break;
    }
    while (true) {
        if ((dstY >= @as(c_int, @bitCast(@as(c_uint, dst.*.height)))) or ((dstY + h) <= @as(c_int, 0))) return;
        if (dstY < @as(c_int, 0)) {
            h += dstY;
            srcY += dstY;
            dstY = 0;
        }
        if (h > (@as(c_int, @bitCast(@as(c_uint, dst.*.height))) - dstY)) {
            h = @as(c_int, @bitCast(@as(c_uint, dst.*.height))) - dstY;
        }
        if (!false) break;
    }
    while (true) {
        if ((srcY >= @as(c_int, @bitCast(@as(c_uint, src.*.height)))) or ((srcY + h) <= @as(c_int, 0))) return;
        if (srcY < @as(c_int, 0)) {
            h += srcY;
            dstY += srcY;
            srcY = 0;
        }
        if (h > (@as(c_int, @bitCast(@as(c_uint, src.*.height))) - srcY)) {
            h = @as(c_int, @bitCast(@as(c_uint, src.*.height))) - srcY;
        }
        if (!false) break;
    }
    var srcD: [*c]@"u32" = schr4c_get_ptr(src, srcX, srcY);
    _ = &srcD;
    var srcL: [*c]@"u32" = undefined;
    _ = &srcL;
    var dstD: [*c]@"u32" = schr4c_get_ptr(dst, dstX, dstY);
    _ = &dstD;
    var dstL: [*c]@"u32" = undefined;
    _ = &dstL;
    var srcP: uint = src.*.pitch / @as(@"u32", @bitCast(@as(c_int, 4)));
    _ = &srcP;
    var dstP: uint = dst.*.pitch / @as(@"u32", @bitCast(@as(c_int, 4)));
    _ = &dstP;
    ...
    _ = &iy;
    var srcX0: c_int = srcX & @as(c_int, 7);
    _ = &srcX0;
    var dstX0: c_int = dstX & @as(c_int, 7);
    _ = &dstX0;
    var mask: @"u32" = undefined;
    _ = &mask;
    if (srcX0 == dstX0) {
        if (srcX0 != @as(c_int, 0)) {
            var right: c_int = min(srcX0 + w, @as(c_int, 8));
            _ = &right;
            var mask_1: @"u32" = chr4_lmask(@as(uint, @bitCast(srcX0))) & chr4_rmask(@as(uint, @bitCast(right)));
            _ = &mask_1;
            {
                iy = 0;
                while (iy < h) : (iy += 1) {
        ...
        if ((w & @as(c_int, 7)) != 0) {
            mask = chr4_rmask(@as(uint, @bitCast(w & @as(c_int, 7))));
            srcL = &srcD[@as(uint, @bitCast(w >> @intCast(3))) *% srcP];
            dstL = &dstD[@as(uint, @bitCast(w >> @intCast(3))) *% dstP];
            {
                iy = 0;
                while (iy < h) : (iy += 1) {
                    (blk: {
                        const tmp = iy;
                        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = ((blk: {
                        const tmp = iy;
                        if (tmp >= 0) break :blk dstL + @as(usize, @intCast(tmp)) else break :blk dstL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* & ~mask) | ((blk: {
                        const tmp = iy;
                        if (tmp >= 0) break :blk srcL + @as(usize, @intCast(tmp)) else break :blk srcL - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* & mask);
                }
            }
            w &= ~@as(c_int, 7);
        ...
        {
            ix = 0;
            while (ix < w) : (ix += @as(c_int, 8)) {
                memcpy32(@as(?*anyopaque, @ptrCast(dstD)), @as(?*const anyopaque, @ptrCast(srcD)), @as(uint, @bitCast(h)));
                srcD += srcP;
                dstD += dstP;
            }
        }
    } else {
        var dx: c_int = dstX0 - srcX0;
        _ = &dx;
        if (dx < @as(c_int, 0)) {
            dx += @as(c_int, 8);
            dstD -= dstP;
        }
        var lsl: uint = @as(uint, @bitCast(@as(c_int, 4) * dx));
        _ = &lsl;
        var lsr: uint = @as(uint, @bitCast(@as(c_int, 32) - (@as(c_int, 4) * dx)));
        _ = &lsr;
        mask = chr4_lmask(@as(uint, @bitCast(srcX0)));
        {
            ix = srcX0 + w;
            while (ix > @as(c_int, 0)) : (ix -= @as(c_int, 8)) {
                if (ix < @as(c_int, 8)) {
                    mask &= chr4_rmask(@as(uint, @bitCast(ix)));
                }
                dstL = dstD;
                dstD += dstP;
                srcL = srcD;
                srcD += srcP;
                {
                    ...
                    while (iy < h) : (iy += 1) {
                        ...
                        _ = &px;
                        dstL[@as(c_uint, @intCast(@as(c_int, 0)))] = (dstL[@as(c_uint, @intCast(@as(c_int, 0)))] & ~(mask << @intCast(lsl))) | (px << @intCast(lsl));
                        dstL[dstP] = (dstL[dstP] & ~(mask >> @intCast(lsr))) | (px >> @intCast(lsr));
                        dstL += 1;
                    }
                }
                mask = 4294967295;
...
pub export fn schr4c_floodfill(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var clr = arg_clr;
    _ = &clr;
    var clrOld: @"u32" = _schr4c_get_pixel(dst, x, y);
    _ = &clrOld;
    if (clr == clrOld) return;
    schr4c_floodfill_internal(dst, x, y, clr, clrOld);
}
pub export fn schr4c_prep_map(arg_srf: [*c]const TSurface, arg_map: [*c]@"u16", arg_se0: @"u16") void {
    var srf = arg_srf;
    _ = &srf;
    var map = arg_map;
    _ = &map;
    var se0 = arg_se0;
    _ = &se0;
    var ix: uint = undefined;
    _ = &ix;
    var iy: uint = undefined;
    _ = &iy;
    var width: uint = @as(uint, @bitCast(@divTrunc(@as(c_int, @bitCast(@as(c_uint, srf.*.width))), @as(c_int, 8))));
    _ = &width;
    var height: uint = @as(uint, @bitCast(@divTrunc(@as(c_int, @bitCast(@as(c_uint, srf.*.height))), @as(c_int, 8))));
    _ = &height;
    var pitch: uint = srf.*.pitch / @as(@"u32", @bitCast(@as(c_int, 32)));
    _ = &pitch;
    {
        iy = 0;
        while (iy < height) : (iy +%= 1) {
            ix = 0;
            while (ix < width) : (ix +%= 1) {
                map[(iy *% @as(uint, @bitCast(@as(c_int, 32)))) +% ix] = @as(@"u16", @bitCast(@as(c_ushort, @truncate(((ix *% pitch) +% iy) +% @as(uint, @bitCast(@as(c_uint, se0)))))));
            }
        }
    }
}
pub export fn schr4c_get_ptr(arg_srf: [*c]const TSurface, arg_x: c_int, arg_y: c_int) [*c]@"u32" {
    var srf = arg_srf;
    _ = &srf;
    var x = arg_x;
    _ = &x;
    ...
    var xx: uint = @as(uint, @bitCast(x));
    _ = &xx;
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    return @as([*c]@"u32", @ptrCast(@alignCast((srf.*.data + (yy *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% srf.*.pitch))));
}
pub fn _schr4c_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") callconv(.c) void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast((dst.*.data + (yy *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% dst.*.pitch))));
    _ = &dstD;
    var shift: uint = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    dstD.* = (dstD.* & @as(@"u32", @bitCast(~(@as(c_int, 15) << @intCast(shift))))) | ((clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift));
}
pub fn _schr4c_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) callconv(.c) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var srcD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast((src.*.data + (yy *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% src.*.pitch))));
    _ = &srcD;
    var shift: uint = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    return (srcD.* >> @intCast(shift)) & @as(@"u32", @bitCast(@as(c_int, 15)));
}
pub extern fn schr4r_get_pixel(src: [*c]const TSurface, x: c_int, y: c_int) @"u32";
pub extern fn schr4r_plot(dst: [*c]const TSurface, x: c_int, y: c_int, clr: @"u32") void;
pub extern fn schr4r_hline(dst: [*c]const TSurface, x1: c_int, y: c_int, x2: c_int, clr: @"u32") void;
pub extern fn schr4r_vline(dst: [*c]const TSurface, x: c_int, y1: c_int, y2: c_int, clr: @"u32") void;
pub extern fn schr4r_line(dst: [*c]const TSurface, x1: c_int, y1: c_int, x2: c_int, y2: c_int, clr: @"u32") void;
pub extern fn schr4r_rect(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn schr4r_frame(dst: [*c]const TSurface, left: c_int, top: c_int, right: c_int, bottom: c_int, clr: @"u32") void;
pub extern fn schr4r_prep_map(srf: [*c]const TSurface, map: [*c]@"u16", se0: @"u16") void;
pub extern fn schr4r_get_ptr(srf: [*c]const TSurface, x: c_int, y: c_int) [*c]@"u32";
pub fn _schr4r_plot(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clr: @"u32") callconv(.c) void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(((dst.*.data + ((yy / @as(uint, @bitCast(@as(c_int, 8)))) *% dst.*.pitch)) + ((yy % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 32)))))));
    _ = &dstD;
    var shift: uint = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    dstD.* = (dstD.* & @as(@"u32", @bitCast(~(@as(c_int, 15) << @intCast(shift))))) | ((clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift));
}
pub fn _schr4r_get_pixel(arg_src: [*c]const TSurface, arg_x: c_int, arg_y: c_int) callconv(.c) @"u32" {
    var src = arg_src;
    _ = &src;
    var x = arg_x;
    _ = &x;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var srcD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast(((src.*.data + ((yy / @as(uint, @bitCast(@as(c_int, 8)))) *% src.*.pitch)) + ((yy % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 32)))))));
    _ = &srcD;
    var shift: uint = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    return (srcD.* >> @intCast(shift)) & @as(@"u32", @bitCast(@as(c_int, 15)));
...
pub extern fn clr_rotate(clrs: [*c]COLOR, nclrs: uint, ror: c_int) void;
pub extern fn clr_blend(srca: [*c]const COLOR, srcb: [*c]const COLOR, dst: [*c]COLOR, nclrs: uint, alpha: @"u32") void;
pub extern fn clr_fade(src: [*c]const COLOR, clr: COLOR, dst: [*c]COLOR, nclrs: uint, alpha: @"u32") void;
pub extern fn clr_grayscale(dst: [*c]COLOR, src: [*c]const COLOR, nclrs: uint) void;
pub extern fn clr_rgbscale(dst: [*c]COLOR, src: [*c]const COLOR, nclrs: uint, clr: COLOR) void;
pub extern fn clr_adj_brightness(dst: [*c]COLOR, src: [*c]const COLOR, nclrs: uint, bright: FIXED) void;
pub extern fn clr_adj_contrast(dst: [*c]COLOR, src: [*c]const COLOR, nclrs: uint, contrast: FIXED) void;
pub extern fn clr_adj_intensity(dst: [*c]COLOR, src: [*c]const COLOR, nclrs: uint, intensity: FIXED) void;
pub extern fn pal_gradient(pal: [*c]COLOR, first: c_int, last: c_int) void;
pub extern fn pal_gradient_ex(pal: [*c]COLOR, first: c_int, last: c_int, clr_first: COLOR, clr_last: COLOR) void;
...
pub fn chr4_lmask(arg_left: uint) callconv(.c) @"u32" {
    var left = arg_left;
    _ = &left;
    return @as(c_uint, 4294967295) << @intCast((left & @as(uint, @bitCast(@as(c_int, 7)))) *% @as(uint, @bitCast(@as(c_int, 4))));
}
pub fn chr4_rmask(arg_right: uint) callconv(.c) @"u32" {
    var right = arg_right;
    _ = &right;
    return @as(c_uint, 4294967295) >> @intCast((-%right & @as(uint, @bitCast(@as(c_int, 7)))) *% @as(uint, @bitCast(@as(c_int, 4))));
}
pub fn chr4c_plot(arg_x: c_int, arg_y: c_int, arg_clr: @"u32", arg_dstBase: ?*anyopaque, arg_dstP: @"u32") callconv(.c) void {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    ...
    var yy: uint = @as(uint, @bitCast(y));
    _ = &yy;
    var dstD: [*c]@"u32" = @as([*c]@"u32", @ptrCast(@alignCast((dstBase + (yy *% @as(uint, @bitCast(@as(c_int, 4))))) + ((xx / @as(uint, @bitCast(@as(c_int, 8)))) *% dstP))));
    _ = &dstD;
    var shift: @"u32" = (xx % @as(uint, @bitCast(@as(c_int, 8)))) *% @as(uint, @bitCast(@as(c_int, 4)));
    _ = &shift;
    dstD.* = (dstD.* & @as(@"u32", @bitCast(~(@as(c_int, 15) << @intCast(shift))))) | ((clr & @as(@"u32", @bitCast(@as(c_int, 15)))) << @intCast(shift));
}
pub fn chr4c_colset(arg_dstD: [*c]@"u32", arg_left: uint, arg_right: uint, arg_height: uint, arg_clr: @"u32") callconv(.c) void {
    var dstD = arg_dstD;
    _ = &dstD;
    var left = arg_left;
    _ = &left;
    ...
    var clr = arg_clr;
    _ = &clr;
    var mask: @"u32" = chr4_lmask(left) & chr4_rmask(right);
    _ = &mask;
    clr &= mask;
    while ((blk: {
        const ref = &height;
...
pub export fn schr4c_floodfill_internal(arg_dst: [*c]const TSurface, arg_x: c_int, arg_y: c_int, arg_clrNew: @"u32", arg_clrOld: @"u32") void {
    var dst = arg_dst;
    _ = &dst;
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
    var clrNew = arg_clrNew;
    _ = &clrNew;
    var clrOld = arg_clrOld;
    _ = &clrOld;
    var dstW: uint = @as(uint, @bitCast(@as(c_uint, dst.*.width)));
    _ = &dstW;
    var dstH: uint = @as(uint, @bitCast(@as(c_uint, dst.*.height)));
    _ = &dstH;
    var ii: c_int = undefined;
    _ = &ii;
    var left: c_int = x;
    ...
    var right: c_int = x;
    _ = &right;
    while ((_schr4c_get_pixel(dst, left - @as(c_int, 1), y) == clrOld) and (left > @as(c_int, 0))) {
        left -= 1;
    }
    while ((_schr4c_get_pixel(dst, right + @as(c_int, 1), y) == clrOld) and (@as(uint, @bitCast(right + @as(c_int, 1))) < dstW)) {
        right += 1;
    }
    schr4c_hline(dst, left, y, right, clrNew);
    {
        ii = left;
        while (ii <= right) : (ii += 1) {
            if ((_schr4c_get_pixel(dst, ii, y - @as(c_int, 1)) == clrOld) and (y > @as(c_int, 0))) {
                schr4c_floodfill_internal(dst, ii, y - @as(c_int, 1), clrNew, clrOld);
            }
            if ((_schr4c_get_pixel(dst, ii, y + @as(c_int, 1)) == clrOld) and (@as(uint, @bitCast(y + @as(c_int, 1))) < dstH)) {
                schr4c_floodfill_internal(dst, ii, y + @as(c_int, 1), clrNew, clrOld);
            }
        }
    }
...
pub const BLIT_CLIP = @compileError("unable to translate C expr: unexpected token 'do'");
// ./src/tonc_schr4c.c:428:9

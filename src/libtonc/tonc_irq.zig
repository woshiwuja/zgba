...
pub const II_VBLANK: c_int = 0;
pub const II_HBLANK: c_int = 1;
pub const II_VCOUNT: c_int = 2;
pub const II_TIMER0: c_int = 3;
pub const II_TIMER1: c_int = 4;
pub const II_TIMER2: c_int = 5;
pub const II_TIMER3: c_int = 6;
pub const II_SERIAL: c_int = 7;
pub const II_DMA0: c_int = 8;
pub const II_DMA1: c_int = 9;
pub const II_DMA2: c_int = 10;
pub const II_DMA3: c_int = 11;
pub const II_KEYPAD: c_int = 12;
pub const II_GAMEPAK: c_int = 13;
pub const II_MAX: c_int = 14;
pub const enum_eIrqIndex = c_uint;
pub const eIrqIndex = enum_eIrqIndex;
pub const struct_IRQ_REC = extern struct {
    flag: @"u32" = @import("std").mem.zeroes(@"u32"),
    isr: fnptr = @import("std").mem.zeroes(fnptr),
};
pub const IRQ_REC = struct_IRQ_REC;
pub extern var __isr_table: [15]IRQ_REC;
pub extern fn isr_master() linksection(".iwram") void;
pub extern fn isr_master_nest() linksection(".iwram") void;
pub export fn irq_init(arg_isr: fnptr) void {
    var isr = arg_isr;
    _ = &isr;
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = 0;
    memset32(@as(?*anyopaque, @ptrCast(@as([*c]IRQ_REC, @ptrCast(@alignCast(&__isr_table[@as(usize, @intCast(0))]))))), @as(@"u32", @bitCast(@as(c_int, 0))), @as(uint, @bitCast(@as(c_uint, @truncate((@as(c_ulonglong, @bitCast(@as(c_longlong, II_MAX + @as(c_int, 1)))) *% @sizeOf(IRQ_REC)) / @as(c_ulonglong, @bitCast(@as(c_longlong, @as(c_int, 4)))))))));
    @as([*c]fnptr, @ptrFromInt(@as(c_int, 67108864) - @as(c_int, 4))).* = if (isr != null) isr else @as(fnptr, @ptrCast(@alignCast(&isr_master)));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = 1;
}
pub export fn irq_set_master(arg_isr: fnptr) fnptr {
    var isr = arg_isr;
    _ = &isr;
    var ime: @"u16" = @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).*;
    _ = &ime;
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = 0;
    var old_isr: fnptr = @as([*c]fnptr, @ptrFromInt(@as(c_int, 67108864) - @as(c_int, 4))).*;
    _ = &old_isr;
    @as([*c]fnptr, @ptrFromInt(@as(c_int, 67108864) - @as(c_int, 4))).* = if (isr != null) isr else @as(fnptr, @ptrCast(@alignCast(&isr_master)));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = ime;
    return old_isr;
}
pub const struct_IRQ_SENDER = extern struct {
    reg_ofs: @"u16" = @import("std").mem.zeroes(@"u16"),
    flag: @"u16" = @import("std").mem.zeroes(@"u16"),
};
pub const IRQ_SENDER = struct_IRQ_SENDER;
pub export fn irq_add(arg_irq_id: enum_eIrqIndex, arg_isr: fnptr) fnptr {
    var irq_id = arg_irq_id;
    _ = &irq_id;
    var isr = arg_isr;
    _ = &isr;
    var ime: @"u16" = @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).*;
    ...
    _ = &ii;
    var irq_flag: @"u16" = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 1) << @intCast(irq_id)))));
    _ = &irq_flag;
    var old_isr: fnptr = undefined;
    _ = &old_isr;
    var pir: [*c]IRQ_REC = @as([*c]IRQ_REC, @ptrCast(@alignCast(&__isr_table[@as(usize, @intCast(0))])));
    _ = &pir;
    var sender: [*c]const IRQ_SENDER = &__irq_senders[irq_id];
    _ = &sender;
    @as([*c]@"u16", @ptrFromInt(@as(c_int, 67108864) + @as(c_int, @bitCast(@as(c_uint, sender.*.reg_ofs))))).* |= @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, sender.*.flag)))))));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 512))).* |= @as(vu16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, irq_flag)))))));
    {
        ii = 0;
        while ((blk: {
            const tmp = ii;
            if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.flag != 0) : (ii += 1) if ((blk: {
            const tmp = ii;
            if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.flag == @as(@"u32", @bitCast(@as(c_uint, irq_flag)))) break;
    }
    old_isr = (blk: {
        const tmp = ii;
        if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    (blk: {
        const tmp = ii;
        if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*.flag = @as(@"u32", @bitCast(@as(c_uint, irq_flag)));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = ime;
    return old_isr;
}
pub export fn irq_delete(arg_irq_id: enum_eIrqIndex) fnptr {
    var irq_id = arg_irq_id;
    _ = &irq_id;
    var ime: @"u16" = @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).*;
    _ = &ime;
...
pub export fn irq_set(arg_irq_id: enum_eIrqIndex, arg_isr: fnptr, arg_opts: @"u32") fnptr {
    var irq_id = arg_irq_id;
    _ = &irq_id;
    var isr = arg_isr;
    _ = &isr;
    ...
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 512))).* |= @as(vu16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, irq_flag)))))));
    {
        ...
        while ((blk: {
            const tmp = slot;
            if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.flag != 0) : (slot += 1) if ((blk: {
            const tmp = slot;
            if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.flag == @as(@"u32", @bitCast(@as(c_uint, irq_flag)))) break;
    }
    prio = @as(c_int, @bitCast(opts & @as(@"u32", @bitCast(@as(c_int, 64) | @as(c_int, 63)))));
    if ((blk: {
        const tmp = slot;
        if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*.flag == @as(@"u32", @bitCast(@as(c_uint, irq_flag)))) {
        if (((opts & @as(@"u32", @bitCast(@as(c_int, 128)))) != 0) or (slot == prio)) {
            old_isr = (blk: {
                const tmp = slot;
                if (tmp >= 0) break :blk pir + @as(usize, @intCast(tmp)) else break :blk pir - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.isr;
...
pub export fn irq_enable(arg_irq_id: enum_eIrqIndex) void {
    var irq_id = arg_irq_id;
    _ = &irq_id;
    var ime: @"u16" = @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).*;
    _ = &ime;
    ...
    _ = &sender;
    @as([*c]@"u16", @ptrFromInt(@as(c_int, 67108864) + @as(c_int, @bitCast(@as(c_uint, sender.*.reg_ofs))))).* |= @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, sender.*.flag)))))));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 512))).* |= @as(vu16, @bitCast(@as(c_short, @truncate(@as(c_int, 1) << @intCast(irq_id)))));
    @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).* = ime;
}
pub export fn irq_disable(arg_irq_id: enum_eIrqIndex) void {
    var irq_id = arg_irq_id;
    _ = &irq_id;
    var ime: @"u16" = @as([*c]volatile vu16, @ptrFromInt(@as(c_int, 67108864) + @as(c_int, 520))).*;
    _ = &ime;
...
pub const __irq_senders: [14]IRQ_SENDER = [14]IRQ_SENDER{
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 8))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 4))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 32))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 258))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 64))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 262))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 64))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 266))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 64))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 270))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 64))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 296))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 186))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 198))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 210))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 222))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 306))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 16384))))),
    },
    IRQ_SENDER{
        .reg_ofs = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 0))))),
        .flag = @as(@"u16", @bitCast(@as(c_short, @truncate(@as(c_int, 0))))),
    },
};
...
pub const TONC_IRQ = "";
pub const ISR_LAST = @as(c_int, 0x0040);
pub const ISR_REPLACE = @as(c_int, 0x0080);
pub const ISR_PRIO_MASK = @as(c_int, 0x003F);
pub const ISR_PRIO_SHIFT = @as(c_int, 0);
pub inline fn ISR_PRIO(n: anytype) @TypeOf(n << ISR_PRIO_SHIFT) {
    _ = &n;
    return n << ISR_PRIO_SHIFT;
}
pub const ISR_DEF = ISR_LAST | ISR_REPLACE;
pub inline fn IRQ_INIT() @TypeOf(irq_init(NULL)) {
    return irq_init(NULL);
}
pub const IRQ_SET = @compileError("unable to translate macro: undefined identifier `II_`");
// .\include/tonc_irq.h:66:9
pub const IRQ_ADD = @compileError("unable to translate macro: undefined identifier `II_`");
// .\include/tonc_irq.h:69:9
